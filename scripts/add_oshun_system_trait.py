#!/usr/bin/env python3
"""Add the Oshun system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "oshun_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T21:03:41Z"

IDENTIFIER = "traitmech:000293"
SYSTEM = "Oshun"
SLUG = "oshun"
PROFILES = ("OsnA2",)
PROFILE_LIST = "OsnA2"
PROFILE_DESCRIPTION = "an OsnA2 HMM profile entry"
PROPOSAL = "proposals/metpo_traitmech_v170"
EMPTY_HMM_NAME = ""
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Mordret et al. directly name Oshun among six Streptomyces "
    ...
    "causal_graphs": [
        {
            ...
            "scope_notes": (
                ...
                f"with {PROFILE_DESCRIPTION} while leaving its phage trigger, "
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        f"An {SYSTEM} anti-phage defense locus cataloged in "
                        f"DefenseFinder with {PROFILE_DESCRIPTION}."
                    ),
                },
                {
            ...
            "edges": [
                {
                    ...
                    "description": (
                        ...
                        f"preprint and catalogs {PROFILE_DESCRIPTION} in the "
                        f"{SYSTEM} model namespace."
                    ),
                    "evidence": [
                        {
                            "reference": MORDRET,
                            "snippet": MORDRET_VALIDATED_SYSTEMS_SNIPPET,
                            "notes": (
                                "Mordret et al. directly name Oshun among six "
                ...
                },
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Oshun as a named system "
                    ...
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Oshun with the Mordret "
    ...
    "discussions": [
        {
            ...
            "rationale": (
                ...
                f"named anti-phage system with {PROFILE_DESCRIPTION}, but the "
