#!/usr/bin/env python3
"""Add the Rhea system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "rhea_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-20T14:45:33Z"

IDENTIFIER = "traitmech:000311"
PROPOSAL = "proposals/metpo_traitmech_v188"
SYSTEM = "Rhea"
SLUG = "rhea"
...
def article_registry_evidence() -> dict[str, str]:
    return {
        ...
        "snippet": (
            "Rhea | 10\\.1093/nar/gkae671 | Discovery of antiphage systems in "
            "the lactococcal plasmidome"
        ),
        "notes": (
            "The DefenseFinder article registry maps the named Rhea system to "
            "the Grafakou et al. lactococcal antiphage-system discovery paper."
        ),
    }
...
RECORD: dict[str, Any] = {
    ...
    "label": "Rhea system",
    "definition": (
        "A phage defense system in which an organism possesses a Rhea locus "
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Grafakou et al. named Rhea among seven not previously "
        ...
        },
        {
            ...
            "notes": (
                "Mosterd et al. later included Rhea among the distinct "
    ...
    "causal_graphs": [
        {
            ...
            "title": "Rhea loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Rhea locus to restricted bacteriophage propagation without "
                "asserting the unresolved phage trigger or molecular output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Rhea as a named lactococcal anti-phage "
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        "A Rhea anti-phage defense locus described among "
                ...
                },
                {
                    ...
                    "description": (
                        "Possession of a genome-encoded Rhea phage-defense "
                        "system."
                    ),
                },
                {
            ...
            "edges": [
                {
                    ...
                    "description": (
                        "The lactococcal plasmidome screen discovered Rhea as "
                        "a named antiphage system, and the DefenseFinder "
                        "article registry maps the Rhea system to that "
                        "discovery paper."
                    ),
                    "evidence": [
                        {
                            ...
                            "snippet": GRAFAKOU_DISCOVERY_SNIPPET,
                            "notes": (
                                "Grafakou et al. named Rhea as one of the "
                ...
                },
                {
                    ...
                    "description": (
                        "Rhea-mediated phage restriction realizes the Rhea "
                        "system trait."
                    ),
                    "evidence": [
                        {
                ...
                },
                {
                    ...
                    "description": (
                        "Rhea system possession is a phage-defense-system "
                        "trait."
                    ),
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Rhea phage triggers and effector outputs before "
                "minting narrower Rhea mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Grafakou et al., Mosterd et al., and DefenseFinder support "
                "Rhea as a named anti-phage system, but the direct trigger, "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Rhea system as a DOI-backed GENOMICS TraitRecord under "
