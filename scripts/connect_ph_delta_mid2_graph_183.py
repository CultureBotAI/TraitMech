...
GRAPH_METADATA_AFTER = {
    ...
    "description": (
        "DOI-backed nonmechanistic graph annotating broad pH-homeostasis "
...
ADDED_EDGES: list[dict[str, Any]] = [
    {
        ...
        "evidence": [
            {
                "reference": "DOI:10.1038/nrmicro2549",
                "snippet": ("the demands of pH homeostasis for particular bacteria determine"),
                "notes": (
                    "Verified against the open PMC manuscript of the Krulwich "
        ...
        "evidence": [
            {
                "reference": "DOI:10.1038/nrmicro2549",
                "snippet": (
                    "In respiratory bacteria the PMF is generated by the respiratory chain"
                ),
                "notes": (
                    "Verified against the open PMC manuscript of the Krulwich "
        ...
        "evidence": [
            {
                ...
                "notes": (
                    ...
                    "the connector keeps F1Fo-ATPase proton efflux as one "
                    "acid-side branch of pH homeostasis."
                ),
            }
        ],
        "predicate_id": "biolink:associated_with",
        ...
        "evidence": [
            {
                "reference": "DOI:10.1038/nrmicro2549",
                "snippet": (
                    "Antiporters with roles in alkaline pH homeostasis "
                    "catalyze electrogenic antiport"
                ),
                "notes": (
                    "Verified against the open PMC manuscript of the Krulwich "
        ...
        "evidence": [
            {
                "reference": "DOI:10.1038/nrmicro2549",
                "snippet": (
                    "Glutamate and arginine decarboxylases are a "
                    "corner-stone of the acid-resistance response"
                ),
                "notes": (
                    "Verified against the open PMC manuscript of the Krulwich "
    ...
    },
    {
        ...
        "object": "broad_ph_homeostasis",
        "description": (
            "Passive cytoplasmic buffering is associated with broad pH-homeostasis flexibility."
        ),
        "evidence": [
            {
                "reference": "DOI:10.3390/antibiotics12091474",
                "snippet": ("representing a passive system in regulating pH homeostasis"),
                "notes": (
                    "Verified against the open Rebelo et al. review; small "
...
def transform(slug: str, doc: dict[str, Any]) -> bool:
    ...
    record_curation_event(
        ...
        changes=(
            ...
            "by adding 6 source- and exact-snippet-backed association "
