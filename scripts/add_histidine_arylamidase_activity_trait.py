#!/usr/bin/env python3
"""Add histidine arylamidase activity with DOI-backed evidence."""
...
TARGET = REPO_ROOT / "data" / "traits" / "physiology" / (
    "histidine_arylamidase_activity.yaml"
)
AMYGDALOBACTER = "DOI:10.1099/ijsem.0.006017"
ACTINOMYCES = "DOI:10.1128/JCM.40.9.3427-3431.2002"
CURATOR = "codex"
TIMESTAMP = "2026-09-12T13:38:31Z"

RECORD = {
    "identifier": "traitmech:000171",
    "label": "histidine arylamidase activity",
    "definition": (
        "A physiological enzyme-activity phenotype in which a cell produces "
        "active histidine arylamidase enzymes that hydrolyze histidine "
    ...
    "synonyms": [
        {
            "synonym_text": "histidine arylamidase",
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Srinivasan et al. listed histidine arylamidase among "
        ...
        },
        {
            ...
            "notes": (
                "Hall et al. reported histidine arylamidase activity in all "
                "eight Actinomyces cardiffensis clinical isolates tested "
    ...
    "canonical_examples": [
        {
            ...
            "note": (
                ...
                "positive for histidine arylamidase activity in an enzyme "
                "activity panel."
            ),
            "reference": AMYGDALOBACTER,
        }
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve an exact external ontology class for histidine "
            ...
            "rationale": (
                ...
                "exact residue-specific histidine arylamidase production "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted histidine arylamidase activity as a DOI-backed "
            "TraitRecord after a repository-wide duplicate review covering "
            "ignored and hidden files; METPO has no exact histidine "
            "arylamidase activity class yet and the placeholder is reserved "
            "in proposals/metpo_traitmech_v48."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
