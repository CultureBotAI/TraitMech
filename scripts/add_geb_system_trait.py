#!/usr/bin/env python3
"""Add the Geb system genomics trait."""
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T17:00:41Z"

IDENTIFIER = "traitmech:000287"
SYSTEM = "Geb"
SLUG = "geb"
PROFILES = ("GebA1", "GebA2")
PROPOSAL = "proposals/metpo_traitmech_v164"
EMPTY_HMM_NAME = ""
            ...
            "edges": [
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "The DefenseFinder registry maps Geb itself "
                ...
                },
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Geb as a named system "
