#!/usr/bin/env python3
"""Add the PD-T4-6 system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "pd_t4_6_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-26T18:33:49Z"
CANONICAL_REVIEW_TIMESTAMP = "2026-09-26T18:33:50Z"
POSED_DATE = "2026-09-26"
IDENTIFIER = "traitmech:000391"
PROPOSAL = "proposals/metpo_traitmech_v268"
SLUG = "pd_t4_6"
...
WIKI_COMPOSITION_SNIPPET = "The PD-T4-6 is composed of 1 protein: PD-T4-6."
STREPTOCOCCUS_EXAMPLE_SNIPPET = (
    "The PD-T4-6 system in *Streptococcus ruminantium* "
    "(GCF_021654555.1, NZ_AP025333) is composed of 1 protein: "
    "PD-T4-6 (WP_024532776.1)"
)
EXPERIMENTAL_GRAPH_SNIPPET = (
    ...
    "<a href='https://ncbi.nlm.nih.gov/protein/RRM76169.1'>"
    "RRM76169.1</a>] --> Expressed_0[Escherichia coli]\n"
...
ARTICLE_REGISTRY_SNIPPET = (
    "PD-T4-6 | 10\\.1101/2022\\.05\\.12\\.491691 | Mapping the landscape "
    "of anti-phage defense mechanisms in the E\\. coli pangenome"
)
RULES_SNIPPET = "PD-T4-6\tPD-T4-6\t1\t1\tPD-T4-6__PD-T4-6\t\t\t"
PROFILE = "PD-T4-6__PD-T4-6"
HMM_ROW = (
    "| PD-T4-6__PD-T4-6                                 | "
    "PD-T4-6__PD-T4-6                                 | "
    "PD-T4-6                | Custom                  | 350    |"
...
def vassallo_screen_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            ...
            "selection that uncovered PD-T4-6 and related conserved "
...
def wiki_composition_evidence() -> dict[str, str]:
    return {
        ...
        "notes": "The DefenseFinder wiki names PD-T4-6 as a single-protein system.",
    }
...
def wiki_refseq_evidence() -> dict[str, str]:
    return {
        "reference": DEFENSEFINDER_WIKI,
        "snippet": STREPTOCOCCUS_EXAMPLE_SNIPPET,
        "notes": (
            "The DefenseFinder wiki illustrates a predicted PD-T4-6 locus "
            "in RefSeq assembly GCF_021654555.1 on NZ_AP025333."
        ),
    }
...
def wiki_validation_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            ...
            "Vassallo et al. to an E. coli PD-T4-6 source locus expressed "
...
def wiki_protects_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            ...
            f"{PHAGE_LIST} in the PD-T4-6 protects-against subgraph."
        ),
    }
...
def article_registry_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder article registry maps the named PD-T4-6 "
...
def rules_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder rules table models PD-T4-6 as a "
...
RECORD: dict[str, Any] = {
    ...
    "label": "PD-T4-6 system",
    "definition": (
        "A phage defense system in which an organism possesses a PD-T4-6 "
    ...
    "causal_graphs": [
        {
            "graph_id": "pd_t4_6_locus_restricts_t2_t4_and_t6",
            "title": f"PD-T4-6 loci restrict {PHAGE_LIST}",
            "description": (
                "Conservative system-level sketch linking possession of a "
                f"PD-T4-6 locus to protection against {PHAGE_LIST}."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures PD-T4-6 as a named DefenseFinder "
            ...
            "nodes": [
                {
                    "node_id": "pd_t4_6_locus",
                    "label": "PD-T4-6 locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A phage-defense locus represented by the PD-T4-6 "
                        "DefenseFinder profile."
                    ),
                },
                {
                    "node_id": "pd_t4_6_listed_phage_protection",
                    "label": f"{PHAGE_LIST} protection",
                    "node_type": "BIOLOGICAL_PROCESS",
                    "description": f"Protection against {PHAGE_LIST} by PD-T4-6.",
                },
                {
                    ...
                    "description": (
                        "Possession of a genome-encoded PD-T4-6 "
            ...
            "edges": [
                {
                    "subject": "pd_t4_6_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "pd_t4_6_listed_phage_protection",
                    "description": (
                        "The DefenseFinder wiki links a PD-T4-6 locus from "
                        "Vassallo et al. to protection against "
                        f"{PHAGE_LIST}, and DefenseFinder models PD-T4-6 "
                ...
                {
                    "subject": "pd_t4_6_listed_phage_protection",
                    "predicate": "confers",
                    "predicate_id": "METPO:2007700",
                    "object": f"{SLUG}_system_trait",
                    "description": (
                        f"Protection against {PHAGE_LIST} realizes the "
                        "PD-T4-6 system trait."
                    ),
                    "evidence": [
                        wiki_validation_evidence(),
                        wiki_protects_evidence(),
                ...
                },
                {
                    ...
                    "description": (
                        "PD-T4-6 system possession is a phage-defense-system "
                        "trait."
                    ),
                    "evidence": [
                        vassallo_screen_evidence(),
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve PD-T4-6 natural host breadth, direct phage trigger, "
                "and effector mechanism before minting narrower PD-T4-6 "
                "mechanism traits."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Vassallo et al. support PD-T4-6 as one of the conserved "
            ...
            "attaches_to": ["causal_graphs#pd_t4_6_locus_restricts_t2_t4_and_t6"],
            "posed_by": CURATOR,
...
def write_record(*, apply: bool) -> None:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted PD-T4-6 system as a DOI- and DefenseFinder-backed "
    ...
    record_curation_event(
        ...
        changes=(
            "Reviewed PD-T4-6 system canonical_examples and left them empty "
            "because the current sources support an E. coli accession-level "
            "experimental validation graph, a DefenseFinder system model, "
            "and a RefSeq Streptococcus ruminantium example, but not a "
            "direct native microbial isolate exemplar with experimentally "
            "verified endogenous PD-T4-6 activity. No paid research was used."
        ),
        llm_assisted=True,
