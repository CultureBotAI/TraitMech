#!/usr/bin/env python3
"""Add the Gao-Ppl system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "gao_ppl_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-22T06:23:08Z"
IDENTIFIER = "traitmech:000356"
PROPOSAL = "proposals/metpo_traitmech_v233"
SLUG = "gao_ppl"

ARTICLE_REGISTRY_SNIPPET = (
    "Gao_Ppl | 10\\.1126/science\\.aba0372 | Diverse enzymatic activities "
    "mediate antiviral immunity in prokaryotes"
)
RULES_SNIPPET = "Gao_Ppl\tGao_Ppl\t1\t1\tGao_Ppl__PplA"
HMM_ROWS = {
    "Gao_Ppl__PplA": (
        "| Gao_Ppl__PplA                                    | "
        "Gao_Ppl__PplA                                    | "
...
def article_registry_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder article registry maps the named Gao_Ppl "
...
def rules_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder rules table models Gao_Ppl as a "
            "single-mandatory-profile system with the Gao_Ppl__PplA "
            "profile."
        ),
    }
...
def hmm_evidence(profile: str) -> dict[str, str]:
    return {
        ...
        "notes": (
            f"The DefenseFinder HMM inventory records {profile} under Gao_Ppl."
        ),
    }
...
RECORD: dict[str, Any] = {
    ...
    "label": "Gao-Ppl system",
    "definition": (
        "A phage defense system in which an organism possesses a Gao_Ppl "
        "locus represented by DefenseFinder as a single-profile model "
        "requiring Gao_Ppl__PplA."
    ),
    ...
    "causal_graphs": [
        {
            "graph_id": "gao_ppl_locus_restricts_phage",
            "title": "Gao-Ppl loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Gao_Ppl locus to Gao et al. antiviral cassette defense "
                "without asserting the unresolved PplA component activity."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Gao-Ppl as a named DefenseFinder "
                "single-profile Gao-family system while leaving natural "
                "hosts, PplA protein function, phage triggers, and direct "
                "effector activity unresolved."
            ),
            "nodes": [
                {
                    "node_id": "gao_ppl_locus",
                    "label": "Gao_Ppl locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A DefenseFinder Gao_Ppl phage-defense locus "
                        "represented by a custom PplA profile."
                    ),
                },
                {
                ...
                },
                {
                    ...
                    "description": (
                        "Possession of a genome-encoded Gao-Ppl "
            ...
            "edges": [
                {
                    "subject": "gao_ppl_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "gao_2020_antiviral_cassette_defense",
                    "description": (
                        "DefenseFinder maps Gao_Ppl to the Gao et al. "
                ...
                },
                {
                    ...
                    "description": (
                        "Gao_Ppl-associated antiviral cassette defense "
                        "realizes the Gao-Ppl system trait."
                    ),
                    "evidence": [
                        {
                            "reference": GAO_PMID,
                ...
                },
                {
                    ...
                    "description": (
                        "Gao-Ppl system possession is a phage-defense-system "
                        "trait."
                    ),
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Gao_Ppl natural hosts, PplA component function, "
                "phage triggers, and effector activity before minting "
                "narrower Gao_Ppl mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                ...
                "DefenseFinder models Gao_Ppl as a single-profile system. "
                "The exact natural host breadth, PplA component identity, "
                "phage trigger, and profile-to-activity mapping remain "
                "unresolved."
            ),
            "attaches_to": ["causal_graphs#gao_ppl_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Gao-Ppl system as a DOI-backed GENOMICS TraitRecord "
