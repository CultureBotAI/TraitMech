...
POST_444_CANONICAL_EXAMPLE_QUEUE = {
    ...
    "genomics/ambrosia_system",
    "genomics/aristaios_system",
    "genomics/audmula_system",
    "genomics/azaca_system",
    "genomics/belenos_system",
    "genomics/belisama_system",
    "genomics/bil_system",
    "genomics/brig1_system",
    ...
    "genomics/dctpdeaminase_system",
    "genomics/ddmde_system",
    "genomics/detocs_system",
    "genomics/dpd_system",
    "genomics/drt_system",
    "genomics/dsr_system",
    "genomics/dgtpase_system",
    "genomics/dionysus_system",
    ...
    "genomics/gao_qat_system",
    "genomics/gao_rl_system",
    "genomics/gao_tmn_system",
    "genomics/gao_tery_system",
    ...
    "genomics/oshun_system",
    "genomics/panchino_gp28_system",
    "genomics/prithvi_system",
    "genomics/prometheus_system",
