#!/usr/bin/env python3
"""Add tyrosine arylamidase activity with DOI-backed evidence."""
...
TARGET = REPO_ROOT / "data" / "traits" / "physiology" / (
    "tyrosine_arylamidase_activity.yaml"
)
AMYGDALOBACTER = "DOI:10.1099/ijsem.0.006017"
ACTINOMYCES = "DOI:10.1128/JCM.40.9.3427-3431.2002"
CURATOR = "codex"
TIMESTAMP = "2026-09-12T12:37:31Z"

RECORD = {
    "identifier": "traitmech:000169",
    "label": "tyrosine arylamidase activity",
    "definition": (
        "A physiological enzyme-activity phenotype in which a cell produces "
        "active tyrosine arylamidase enzymes that hydrolyze tyrosine "
    ...
    "synonyms": [
        {
            "synonym_text": "tyrosine arylamidase",
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Srinivasan et al. listed tyrosine arylamidase among "
        ...
        },
        {
            ...
            "notes": (
                "Hall et al. reported tyrosine arylamidase activity in all "
    ...
    "canonical_examples": [
        {
            ...
            "note": (
                ...
                "positive for tyrosine arylamidase activity in an enzyme "
                "activity panel."
            ),
            "reference": AMYGDALOBACTER,
        }
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve an exact external ontology class for tyrosine "
            ...
            "rationale": (
                ...
                "exact residue-specific tyrosine arylamidase production "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted tyrosine arylamidase activity as a DOI-backed "
            "TraitRecord after a repository-wide duplicate review covering "
            "ignored and hidden files; METPO has no exact tyrosine "
            "arylamidase activity class yet and the placeholder is reserved "
            "in proposals/metpo_traitmech_v46."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
