#!/usr/bin/env python3
"""Add the Epona system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "epona_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T14:03:55Z"
...
def hmm_inventory_evidence() -> dict[str, str]:
    hmm = f"Epona__{PROFILE}"
    return {
        "reference": DEFENSEFINDER_HMMS,
        "snippet": f"{hmm:<48} | {EMPTY_HMM_NAME:<48} | Epona",
        "notes": (
            "The DefenseFinder HMM inventory records "
            f"{PROFILE} in the Epona model namespace."
        ),
    }


RECORD: dict[str, Any] = {
    "identifier": "traitmech:000281",
    "label": "Epona system",
    "definition": (
        "A phage defense system in which an organism possesses an Epona "
        "locus represented by a VCA0366 profile that can protect bacteria "
    ...
    "evidence": [
        ...
        },
        {
            ...
            "notes": (
                ...
                "does not assert a resolved Epona trigger, effector output, "
        ...
        },
        {
            ...
            "snippet": (
                "Epona | 10\\.1126/science\\.ads0768 | Sedentary "
                "chromosomal integrons as biobanks of bacterial antiphage "
                "defense systems"
            ),
            "notes": (
                "The DefenseFinder model registry maps the named Epona "
    ...
    "causal_graphs": [
        {
            "graph_id": "epona_locus_restricts_phage",
            "title": "Epona loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of an "
                "Epona locus to restricted bacteriophage propagation without "
                "asserting the unresolved phage trigger or molecular output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Epona as a named SCI-derived "
                "anti-phage system with a VCA0366 DefenseFinder profile "
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        "An Epona anti-phage defense locus represented in "
                        "DefenseFinder by a VCA0366 profile."
                    ),
                },
                {
                    ...
                    "description": (
                        ...
                        "carrying the Epona system."
                    ),
                },
                {
                    "node_id": "epona_system_trait",
                    "label": "Epona system",
                    "node_type": "TRAIT",
                    "grounding": "traitmech:000281",
                    "description": (
                        "Possession of a genome-encoded Epona phage-defense "
                        "system."
                    ),
                },
                {
            ...
            "edges": [
                {
                    ...
                    "description": (
                        "DefenseFinder maps Epona to an SCI "
                        "anti-phage-system discovery paper and represents "
                        "Epona loci through the VCA0366 component profile."
                    ),
                    "evidence": [
                        {
                            "reference": DARRACQ,
                            ...
                            "notes": (
                                ...
                                "DefenseFinder Epona registry row maps to "
                                "the Epona system."
                            ),
                        },
                        {
                            **hmm_inventory_evidence(),
                            "notes": (
                                ...
                                "VCA0366 as the Epona component profile."
                            ),
                        },
                    ],
                },
                {
                    ...
                    "object": "epona_system_trait",
                    "description": (
                        "Epona-mediated phage restriction realizes the "
                        "Epona system trait."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "Darracq et al. place the Epona discovery "
                ...
                {
                    "subject": "epona_system_trait",
                    "predicate": "is a",
                    "predicate_id": "rdfs:subClassOf",
                    "object": "phage_defense_system",
                    "description": (
                        "Epona system possession is a "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Epona phage triggers and effector outputs before "
                "minting narrower Epona mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Darracq et al. and DefenseFinder support Epona as a named "
                "anti-phage system with a VCA0366 profile, but the trigger, "
            ...
            "attaches_to": ["causal_graphs#epona_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Epona system as a DOI-backed GENOMICS TraitRecord "
            ...
            "proposals/metpo_traitmech_v158."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
