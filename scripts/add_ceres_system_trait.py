#!/usr/bin/env python3
"""Add the Ceres system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "ceres_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T18:23:47Z"

IDENTIFIER = "traitmech:000288"
SYSTEM = "Ceres"
SLUG = "ceres"
PROFILES = ("CrsA1", "CrsA2")
PROPOSAL = "proposals/metpo_traitmech_v165"
EMPTY_HMM_NAME = ""
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Mordret et al. directly name Ceres among six Streptomyces "
    ...
    "causal_graphs": [
        {
            ...
            "scope_notes": (
                ...
                "with CrsA1 and CrsA2 DefenseFinder HMM profile entries while "
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        ...
                        "DefenseFinder with CrsA1 and CrsA2 HMM profile entries."
                    ),
                },
                {
            ...
            "edges": [
                {
                    ...
                    "description": (
                        ...
                        "preprint and catalogs CrsA1 and CrsA2 HMM profile "
                    ...
                    "evidence": [
                        {
                            ...
                            "snippet": MORDRET_VALIDATED_SYSTEMS_SNIPPET,
                            "notes": (
                                "Mordret et al. directly name Ceres among six "
                ...
                },
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Ceres as a named system "
                    ...
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Ceres with the Mordret "
    ...
    "discussions": [
        {
            ...
            "rationale": (
                ...
                "named anti-phage system with CrsA1 and CrsA2 HMM profile entries, "
