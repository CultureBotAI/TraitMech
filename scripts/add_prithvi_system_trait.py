#!/usr/bin/env python3
"""Add the Prithvi system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "prithvi_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T19:16:49Z"

IDENTIFIER = "traitmech:000290"
SYSTEM = "Prithvi"
SLUG = "prithvi"
PROFILE = "PtvA"
PROPOSAL = "proposals/metpo_traitmech_v167"
EMPTY_HMM_NAME = ""
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Mordret et al. directly name Prithvi among six Streptomyces "
    ...
    "causal_graphs": [
        {
            ...
            "scope_notes": (
                ...
                f"{PROFILE} DefenseFinder HMM profile entry while leaving its "
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        ...
                        f"DefenseFinder with a {PROFILE} HMM profile entry."
                    ),
                },
                {
            ...
            "edges": [
                {
                    ...
                    "description": (
                        ...
                        f"preprint and catalogs a {PROFILE} HMM profile entry "
                        f"in the {SYSTEM} model namespace."
                    ),
                    "evidence": [
                        {
                            "reference": MORDRET,
                            "snippet": MORDRET_VALIDATED_SYSTEMS_SNIPPET,
                            "notes": (
                                "Mordret et al. directly name Prithvi among six "
                        ...
                        },
                        {
                            "reference": DEFENSEFINDER_ARTICLES,
                            "snippet": (
                                "Prithvi | 10\\.1101/2025\\.01\\.08\\.631966 | "
                                "Protein and genomic language models chart a "
                                "vast landscape of antiphage defenses"
                            ),
                            "notes": (
                                "The DefenseFinder registry maps Prithvi itself "
                ...
                },
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Prithvi as a named system "
                    ...
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Prithvi with the Mordret "
    ...
    "discussions": [
        {
            ...
            "rationale": (
                ...
                f"named anti-phage system with a {PROFILE} HMM profile entry, "
