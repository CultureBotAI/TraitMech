#!/usr/bin/env python3
"""Add glycine arylamidase activity with DOI-backed evidence."""
...
TARGET = REPO_ROOT / "data" / "traits" / "physiology" / (
    "glycine_arylamidase_activity.yaml"
)
AMYGDALOBACTER = "DOI:10.1099/ijsem.0.006017"
ACTINOMYCES = "DOI:10.1128/JCM.40.9.3427-3431.2002"
CURATOR = "codex"
TIMESTAMP = "2026-09-12T13:05:26Z"

RECORD = {
    "identifier": "traitmech:000170",
    "label": "glycine arylamidase activity",
    "definition": (
        "A physiological enzyme-activity phenotype in which a cell produces "
        "active glycine arylamidase enzymes that hydrolyze glycine arylamide "
        "substrates."
    ),
    ...
    "synonyms": [
        {
            "synonym_text": "glycine arylamidase",
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Srinivasan et al. listed glycine arylamidase among "
        ...
        },
        {
            ...
            "notes": (
                "Hall et al. reported glycine arylamidase activity in all "
    ...
    "canonical_examples": [
        {
            ...
            "note": (
                ...
                "positive for glycine arylamidase activity in an enzyme "
                "activity panel."
            ),
            "reference": AMYGDALOBACTER,
        }
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve an exact external ontology class for glycine "
            ...
            "rationale": (
                ...
                "exact residue-specific glycine arylamidase production "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted glycine arylamidase activity as a DOI-backed "
            "TraitRecord after a repository-wide duplicate review covering "
            "ignored and hidden files; METPO has no exact glycine "
            "arylamidase activity class yet and the placeholder is reserved "
            "in proposals/metpo_traitmech_v47."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
