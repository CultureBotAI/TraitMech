#!/usr/bin/env python3
"""Add the Lugos system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "lugos_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T15:04:20Z"

IDENTIFIER = "traitmech:000283"
SYSTEM = "Lugos"
SLUG = "lugos"
PROFILE = "VCA0409"
PROPOSAL = "proposals/metpo_traitmech_v160"
EMPTY_HMM_NAME = ""
    ...
    "causal_graphs": [
        {
            ...
            "edges": [
                ...
                },
                {
                    ...
                    "description": (
                        f"{SYSTEM} system possession is a phage-defense-system trait."
                    ),
                    "evidence": [
                        {
                            "reference": DEFENSEFINDER_ARTICLES,
