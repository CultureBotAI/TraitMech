#!/usr/bin/env python3
"""Add the Gao-Hhe system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "gao_hhe_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-22T02:45:35Z"
IDENTIFIER = "traitmech:000353"
PROPOSAL = "proposals/metpo_traitmech_v230"
SLUG = "gao_hhe"

ARTICLE_REGISTRY_SNIPPET = (
    "Gao_Hhe | 10\\.1126/science\\.aba0372 | Diverse enzymatic activities "
    "mediate antiviral immunity in prokaryotes"
)
RULES_SNIPPET = "Gao_Hhe\tGao_Hhe\t1\t1\tGao_Hhe__HheA"
HMM_ROWS = {
    "Gao_Hhe__HheA": (
        "| Gao_Hhe__HheA                                    | "
        "Gao_Hhe__HheA                                    | "
...
def article_registry_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder article registry maps the named Gao_Hhe "
...
def rules_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder rules table models Gao_Hhe as a "
            "single-mandatory-profile system with the Gao_Hhe__HheA "
            "profile."
        ),
    }
...
def hmm_evidence(profile: str) -> dict[str, str]:
    return {
        ...
        "notes": (
            f"The DefenseFinder HMM inventory records {profile} under Gao_Hhe."
        ),
    }
...
RECORD: dict[str, Any] = {
    ...
    "label": "Gao-Hhe system",
    "definition": (
        "A phage defense system in which an organism possesses a Gao_Hhe "
        "locus represented by DefenseFinder as a single-profile model "
        "requiring Gao_Hhe__HheA."
    ),
    ...
    "causal_graphs": [
        {
            "graph_id": "gao_hhe_locus_restricts_phage",
            "title": "Gao-Hhe loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Gao_Hhe locus to Gao et al. antiviral cassette defense "
                "without asserting the unresolved HheA component activity."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Gao-Hhe as a named DefenseFinder "
                "single-profile Gao-family system while leaving natural "
                "hosts, HheA protein function, phage triggers, and direct "
                "effector activity unresolved."
            ),
            "nodes": [
                {
                    "node_id": "gao_hhe_locus",
                    "label": "Gao_Hhe locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A DefenseFinder Gao_Hhe phage-defense locus "
                        "represented by a custom HheA profile."
                    ),
                },
                {
                ...
                },
                {
                    ...
                    "description": (
                        "Possession of a genome-encoded Gao-Hhe "
            ...
            "edges": [
                {
                    "subject": "gao_hhe_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "gao_2020_antiviral_cassette_defense",
                    "description": (
                        "DefenseFinder maps Gao_Hhe to the Gao et al. "
                ...
                },
                {
                    ...
                    "description": (
                        "Gao_Hhe-associated antiviral cassette defense "
                        "realizes the Gao-Hhe system trait."
                    ),
                    "evidence": [
                        {
                            "reference": GAO_PMID,
                ...
                },
                {
                    ...
                    "description": (
                        "Gao-Hhe system possession is a phage-defense-system "
                        "trait."
                    ),
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Gao_Hhe natural hosts, HheA component function, "
                "phage triggers, and effector activity before minting "
                "narrower Gao_Hhe mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                ...
                "DefenseFinder models Gao_Hhe as a single-profile system. "
                "The exact natural host breadth, HheA component identity, "
                "phage trigger, and profile-to-activity mapping remain "
                "unresolved."
            ),
            "attaches_to": ["causal_graphs#gao_hhe_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Gao-Hhe system as a DOI-backed GENOMICS TraitRecord "
