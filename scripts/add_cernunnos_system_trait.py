#!/usr/bin/env python3
"""Add the Cernunnos system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "cernunnos_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T08:00:30Z"
...
def hmm_inventory_evidence() -> dict[str, str]:
    hmm = f"Cernunnos__{PROFILE}"
    return {
        "reference": DEFENSEFINDER_HMMS,
        "snippet": f"{hmm:<48} | {EMPTY_HMM_NAME:<48} | Cernunnos",
        "notes": (
            "The DefenseFinder HMM inventory records "
            f"{PROFILE} in the Cernunnos model namespace."
        ),
    }


RECORD: dict[str, Any] = {
    "identifier": "traitmech:000271",
    "label": "Cernunnos system",
    "definition": (
        "A phage defense system in which an organism possesses a Cernunnos "
        "locus represented by a VCA0410 profile that can protect bacteria "
    ...
    "evidence": [
        ...
        },
        {
            ...
            "notes": (
                ...
                "does not assert a resolved Cernunnos trigger, effector "
        ...
        },
        {
            ...
            "snippet": (
                "Cernunnos | 10\\.1126/science\\.ads0768 | Sedentary "
                "chromosomal integrons as biobanks of bacterial antiphage "
                "defense systems"
            ),
            "notes": (
                "The DefenseFinder model registry maps the named Cernunnos "
    ...
    "causal_graphs": [
        {
            "graph_id": "cernunnos_locus_restricts_phage",
            "title": "Cernunnos loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Cernunnos locus to restricted bacteriophage propagation "
                "without asserting the unresolved phage trigger or molecular "
                "output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Cernunnos as a named SCI-derived "
                "anti-phage system with a VCA0410 DefenseFinder profile "
                "while leaving its phage trigger, molecular substrate, "
                "antiviral effector output, and subtype breadth unresolved."
            ),
            "nodes": [
                {
                    "node_id": "cernunnos_locus",
                    "label": "Cernunnos locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A Cernunnos anti-phage defense locus represented in "
                        "DefenseFinder by a VCA0410 profile."
                    ),
                },
                {
                    ...
                    "description": (
                        ...
                        "carrying the Cernunnos system."
                    ),
                },
                {
                    "node_id": "cernunnos_system_trait",
                    "label": "Cernunnos system",
                    "node_type": "TRAIT",
                    "grounding": "traitmech:000271",
                    "description": (
                        "Possession of a genome-encoded Cernunnos "
            ...
            "edges": [
                {
                    "subject": "cernunnos_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "restricted_phage_propagation",
                    "description": (
                        "DefenseFinder maps Cernunnos to an SCI "
                        "anti-phage-system discovery paper and represents "
                        "Cernunnos loci through the VCA0410 component profile."
                    ),
                    "evidence": [
                        {
                            "reference": DARRACQ,
                            ...
                            "notes": (
                                ...
                                "DefenseFinder Cernunnos registry row maps to "
                                "the Cernunnos system."
                            ),
                        },
                        {
                            **hmm_inventory_evidence(),
                            "notes": (
                                ...
                                "VCA0410 as the Cernunnos component profile."
                            ),
                        },
                    ],
                },
                {
                    ...
                    "object": "cernunnos_system_trait",
                    "description": (
                        "Cernunnos-mediated phage restriction realizes the "
                        "Cernunnos system trait."
                    ),
                    "evidence": [
                        {
                            "reference": DARRACQ,
                            ...
                            "notes": (
                                "Darracq et al. place the Cernunnos discovery "
                ...
                {
                    "subject": "cernunnos_system_trait",
                    "predicate": "is a",
                    "predicate_id": "rdfs:subClassOf",
                    "object": "phage_defense_system",
                    "description": (
                        "Cernunnos system possession is a "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Cernunnos phage triggers and effector outputs before "
                "minting narrower Cernunnos mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Darracq et al. and DefenseFinder support Cernunnos as a "
                "named anti-phage system with a VCA0410 profile, but the "
            ...
            "attaches_to": ["causal_graphs#cernunnos_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Cernunnos system as a DOI-backed GENOMICS TraitRecord "
            ...
            "proposals/metpo_traitmech_v148."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
