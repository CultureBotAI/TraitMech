#!/usr/bin/env python3
"""Add the Dodola system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "dodola_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-18T21:38:00Z"
...
def hmm_inventory_evidence(profile: str) -> dict[str, str]:
    return {
        ...
        "snippet": (
            f"Dodola__{profile}                                     | "
            f"Dodola__{profile}                                     | Dodola"
        ),
        "notes": (
            f"The DefenseFinder HMM inventory records {profile} as a "
            "Dodola profile."
        ),
    }
...
RECORD: dict[str, Any] = {
    "identifier": "traitmech:000252",
    "label": "Dodola system",
    "definition": (
        "A phage defense system in which an organism possesses a "
        "two-component Dodola locus represented by DolA and DolB profiles "
    ...
    "evidence": [
        {
            ...
            "notes": (
                ...
                "cohort that DefenseFinder cites for Dodola as a bacterial "
                "anti-phage system."
            ),
        },
        {
            ...
            "notes": (
                ...
                "Dodola article registry."
            ),
        },
        {
            "reference": DEFENSEFINDER_ARTICLES,
            "snippet": (
                "Dodola | 10\\.1101/2022\\.05\\.11\\.491447 | An "
                "expanding arsenal of immune systems that protect bacteria "
                "from phages"
            ),
            "notes": (
                "The DefenseFinder model registry maps the named Dodola "
        ...
        },
        {
            ...
            "snippet": (
                "Dodola\tDodola\t2\t2\tDodola__DolA, Dodola__DolB"
            ),
            "notes": (
                "The DefenseFinder rules table models Dodola as a "
                "two-component system with DolA and DolB as mandatory "
                "profile choices."
            ),
        },
        *(hmm_inventory_evidence(profile) for profile in ("DolA", "DolB")),
    ],
    "causal_graphs": [
        {
            "graph_id": "dodola_locus_restricts_phage",
            "title": "Dodola loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Dodola locus to restricted bacteriophage propagation "
                "without asserting the unresolved phage trigger or molecular "
                "output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Dodola as a named anti-phage system with "
                "DefenseFinder DolA and DolB profiles while leaving its "
                "phage trigger, molecular substrate, antiviral effector "
                "output, and subtype breadth unresolved."
            ),
            "nodes": [
                {
                    "node_id": "dodola_locus",
                    "label": "Dodola locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A Dodola anti-phage defense locus satisfying a "
                        "DefenseFinder rule over DolA and DolB profiles."
                    ),
                },
                {
                    ...
                    "description": (
                        ...
                        "carrying the Dodola system."
                    ),
                },
                {
                    "node_id": "dodola_system_trait",
                    "label": "Dodola system",
                    "node_type": "TRAIT",
                    "grounding": "traitmech:000252",
                    "description": (
                        "Possession of a genome-encoded Dodola phage-defense "
                        "system."
                    ),
                },
                {
            ...
            "edges": [
                {
                    "subject": "dodola_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "restricted_phage_propagation",
                    "description": (
                        "DefenseFinder maps Dodola to a bacterial "
                        "anti-phage-system discovery preprint and represents "
                        "Dodola loci through DolA and DolB component "
                        "profiles."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                ...
                                "Dodola registry row maps to the Dodola "
                                "system."
                            ),
                        },
                        {
                        ...
                        },
                        {
                            "reference": DEFENSEFINDER_RULES,
                            "snippet": (
                                "Dodola\tDodola\t2\t2\tDodola__DolA, "
                                "Dodola__DolB"
                            ),
                            "notes": (
                                "The DefenseFinder rules table supports "
                                "DolA and DolB as Dodola system profile "
                                "choices."
                            ),
                        },
                    ],
                },
                {
                    ...
                    "object": "dodola_system_trait",
                    "description": (
                        "Dodola-mediated phage restriction realizes the "
                        "Dodola system trait."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "Millman et al. place the Dodola discovery "
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Dodola as a named "
                ...
                {
                    "subject": "dodola_system_trait",
                    "predicate": "is a",
                    "predicate_id": "rdfs:subClassOf",
                    "object": "phage_defense_system",
                    "description": (
                        "Dodola system possession is a phage-defense-system "
                        "trait."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Dodola with the "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Dodola phage triggers and effector outputs before "
                "minting narrower Dodola mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Millman et al. and DefenseFinder support Dodola as a named "
                "anti-phage system with DolA and DolB profiles, but the "
            ...
            "attaches_to": ["causal_graphs#dodola_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Dodola system as a DOI-backed GENOMICS TraitRecord "
            ...
            "proposals/metpo_traitmech_v129."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
