#!/usr/bin/env python3
"""Add the Ukko system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "ukko_system.yaml"
...
IDENTIFIER = "traitmech:000292"
SYSTEM = "Ukko"
SLUG = "ukko"
PROFILES = ("UkkA1", "UkkA2", "UkkB1", "UkkB2", "UkkC1", "UkkC2", "UkkD1", "UkkD2")
PROFILE_LIST = "UkkA1, UkkA2, UkkB1, UkkB2, UkkC1, UkkC2, UkkD1, and UkkD2"
PROPOSAL = "proposals/metpo_traitmech_v169"
EMPTY_HMM_NAME = ""
    ...
    "evidence": [
        {
            ...
            "notes": (
                "Mordret et al. directly name Ukko among six Streptomyces "
                    ...
                    "evidence": [
                        {
                            ...
                            "snippet": MORDRET_VALIDATED_SYSTEMS_SNIPPET,
                            "notes": (
                                "Mordret et al. directly name Ukko among six "
                ...
                },
                {
                    ...
                    "evidence": [
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Ukko as a named system "
                    ...
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Ukko with the Mordret "
    ...
    "discussions": [
        {
            ...
            "rationale": (
                ...
                f"named anti-phage system with {PROFILE_LIST} HMM profile "
                "entries, but the trigger, molecular substrate, antiviral "
