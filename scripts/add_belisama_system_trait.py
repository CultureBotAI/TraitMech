#!/usr/bin/env python3
"""Add the Belisama system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "belisama_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T07:01:47Z"
...
def hmm_inventory_evidence() -> dict[str, str]:
    hmm = f"Belisama__{PROFILE}"
    return {
        "reference": DEFENSEFINDER_HMMS,
        "snippet": f"{hmm:<48} | {EMPTY_HMM_NAME:<48} | Belisama",
        "notes": (
            "The DefenseFinder HMM inventory records "
            f"{PROFILE} in the Belisama model namespace."
        ),
    }


RECORD: dict[str, Any] = {
    "identifier": "traitmech:000269",
    "label": "Belisama system",
    "definition": (
        "A phage defense system in which an organism possesses a Belisama "
        "locus represented by a VCA0458 profile that can protect bacteria "
    ...
    "evidence": [
        ...
        },
        {
            ...
            "notes": (
                ...
                "does not assert a resolved Belisama trigger, effector "
        ...
        },
        {
            ...
            "snippet": (
                "Belisama | 10\\.1126/science\\.ads0768 | Sedentary "
                "chromosomal integrons as biobanks of bacterial antiphage "
                "defense systems"
            ),
            "notes": (
                "The DefenseFinder model registry maps the named Belisama "
    ...
    "causal_graphs": [
        {
            "graph_id": "belisama_locus_restricts_phage",
            "title": "Belisama loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of a "
                "Belisama locus to restricted bacteriophage propagation "
                "without asserting the unresolved phage trigger or molecular "
                "output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Belisama as a named SCI-derived "
                "anti-phage system with a VCA0458 DefenseFinder profile "
                "while leaving its phage trigger, molecular substrate, "
                "antiviral effector output, and subtype breadth unresolved."
            ),
            "nodes": [
                {
                    "node_id": "belisama_locus",
                    "label": "Belisama locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A Belisama anti-phage defense locus represented in "
                        "DefenseFinder by a VCA0458 profile."
                    ),
                },
                {
                    ...
                    "description": (
                        ...
                        "carrying the Belisama system."
                    ),
                },
                {
                    "node_id": "belisama_system_trait",
                    "label": "Belisama system",
                    "node_type": "TRAIT",
                    "grounding": "traitmech:000269",
                    "description": (
                        "Possession of a genome-encoded Belisama "
            ...
            "edges": [
                {
                    "subject": "belisama_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "restricted_phage_propagation",
                    "description": (
                        "DefenseFinder maps Belisama to an SCI "
                        "anti-phage-system discovery paper and represents "
                        "Belisama loci through the VCA0458 component profile."
                    ),
                    "evidence": [
                        {
                            "reference": DARRACQ,
                            ...
                            "notes": (
                                ...
                                "DefenseFinder Belisama registry row maps to "
                                "the Belisama system."
                            ),
                        },
                        {
                            **hmm_inventory_evidence(),
                            "notes": (
                                ...
                                "VCA0458 as the Belisama component profile."
                            ),
                        },
                    ],
                },
                {
                    ...
                    "object": "belisama_system_trait",
                    "description": (
                        "Belisama-mediated phage restriction realizes the "
                        "Belisama system trait."
                    ),
                    "evidence": [
                        {
                            "reference": DARRACQ,
                            ...
                            "notes": (
                                "Darracq et al. place the Belisama discovery "
                ...
                {
                    "subject": "belisama_system_trait",
                    "predicate": "is a",
                    "predicate_id": "rdfs:subClassOf",
                    "object": "phage_defense_system",
                    "description": (
                        "Belisama system possession is a "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Belisama phage triggers and effector outputs before "
                "minting narrower Belisama mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Darracq et al. and DefenseFinder support Belisama as a named "
                "anti-phage system with a VCA0458 profile, but the trigger, "
            ...
            "attaches_to": ["causal_graphs#belisama_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Belisama system as a DOI-backed GENOMICS TraitRecord "
            ...
            "proposals/metpo_traitmech_v146."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
