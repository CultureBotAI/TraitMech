    ...
    "evidence": [
        {
            "reference": BUCKEL,
            "snippet": (
                "Until about 10 years ago, anaerobes were thought to "
                "exclusively use substrate level phosphorylation (SLP), by "
                "which only part of the available energy could be conserved. "
                "Therefore, anaerobes were regarded as unproductive and "
                "inefficient energy conservers. The discovery of "
                "electrochemical Na+ gradients generated by "
                "biotin-dependent decarboxylations or by reduction of NAD+ "
        ...
        },
        {
            "reference": BAROI,
            "snippet": (
                "the adapted C. tyrobutyricum strain was characterized by a "
                "high yield and selectivity to butyric acid"
            ),
            "notes": (
