#!/usr/bin/env python3
"""Add the Olokun system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "olokun_system.yaml"
...
def hmm_inventory_evidence(profile: str) -> dict[str, str]:
    hmm = f"Olokun__{profile}"
    return {
        "reference": DEFENSEFINDER_HMMS,
        "snippet": f"{hmm:<49} | {hmm:<49} | Olokun",
        "notes": (
            "The DefenseFinder HMM inventory records "
            f"{profile} as an Olokun profile."
        ),
    }


RECORD: dict[str, Any] = {
    "identifier": "traitmech:000254",
    "label": "Olokun system",
    "definition": (
        "A phage defense system in which an organism possesses a "
        "two-component Olokun locus represented by OloA and OloB profiles "
    ...
    "evidence": [
        {
            ...
            "notes": (
                ...
                "cohort that DefenseFinder cites for Olokun as a bacterial "
                "anti-phage system."
            ),
        },
        {
            ...
            "notes": (
                ...
                "Olokun article registry."
            ),
        },
        {
            "reference": DEFENSEFINDER_ARTICLES,
            "snippet": (
                "Olokun | 10\\.1101/2022\\.05\\.11\\.491447 | An "
                "expanding arsenal of immune systems that protect bacteria "
                "from phages"
            ),
            "notes": (
                "The DefenseFinder model registry maps the named Olokun "
        ...
        },
        {
            ...
            "snippet": "Olokun\tOlokun\t2\t2\tOlokun__OloA, Olokun__OloB",
            "notes": (
                "The DefenseFinder rules table models Olokun with OloA and "
                "OloB profiles."
            ),
        },
    ...
    "causal_graphs": [
        {
            "graph_id": "olokun_locus_restricts_phage",
            "title": "Olokun loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of an "
                "Olokun locus to restricted bacteriophage propagation "
                "without asserting the unresolved phage trigger or molecular "
                "output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures Olokun as a named anti-phage system "
                "with DefenseFinder OloA and OloB profile choices while "
                "leaving its phage trigger, molecular substrate, antiviral "
                "effector output, and subtype breadth unresolved."
            ),
            "nodes": [
                {
                    "node_id": "olokun_locus",
                    "label": "Olokun locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "An Olokun anti-phage defense locus satisfying a "
                        "DefenseFinder rule over OloA and OloB profiles."
                    ),
                },
                {
                    ...
                    "description": (
                        ...
                        "carrying the Olokun system."
                    ),
                },
                {
                    "node_id": "olokun_system_trait",
                    "label": "Olokun system",
                    "node_type": "TRAIT",
                    "grounding": "traitmech:000254",
                    "description": (
                        "Possession of a genome-encoded Olokun phage-defense "
                        "system."
                    ),
                },
                {
            ...
            "edges": [
                {
                    "subject": "olokun_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "restricted_phage_propagation",
                    "description": (
                        "DefenseFinder maps Olokun to a bacterial "
                        "anti-phage-system discovery preprint and represents "
                        "Olokun loci through OloA and OloB component "
                        "profiles."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                ...
                                "Olokun registry row maps to the Olokun "
                                "system."
                            ),
                        },
                        {
                        ...
                        },
                        {
                            "reference": DEFENSEFINDER_RULES,
                            "snippet": (
                                "Olokun\tOlokun\t2\t2\tOlokun__OloA, "
                                "Olokun__OloB"
                            ),
                            "notes": (
                                "The DefenseFinder rules table supports "
                                "OloA and OloB as Olokun system profile "
                                "choices."
                            ),
                        },
                    ],
                },
                {
                    ...
                    "object": "olokun_system_trait",
                    "description": (
                        "Olokun-mediated phage restriction realizes the "
                        "Olokun system trait."
                    ),
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "Millman et al. place the Olokun discovery "
                                "cohort in the set of bacterial systems "
                        ...
                        },
                        {
                            ...
                            "notes": (
                                "DefenseFinder records Olokun as a named "
                ...
                {
                    "subject": "olokun_system_trait",
                    "predicate": "is a",
                    "predicate_id": "rdfs:subClassOf",
                    "object": "phage_defense_system",
                    "description": (
                        "Olokun system possession is a "
                    ...
                    "evidence": [
                        {
                            ...
                            "notes": (
                                "DefenseFinder associates Olokun with the "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve Olokun phage triggers and effector outputs before "
                "minting narrower Olokun mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                "Millman et al. and DefenseFinder support Olokun as a named "
                "anti-phage system with OloA and OloB profile choices, but "
            ...
            "attaches_to": ["causal_graphs#olokun_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted Olokun system as a DOI-backed GENOMICS TraitRecord "
            ...
            "in proposals/metpo_traitmech_v131."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
