#!/usr/bin/env python3
"""Add the FS-Sma system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "fs_sma_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-22T00:54:34Z"
IDENTIFIER = "traitmech:000351"
PROPOSAL = "proposals/metpo_traitmech_v228"
SLUG = "fs_sma"

ARTICLE_REGISTRY_SNIPPET = (
    "FS_Sma | 10\\.1016/j\\.cell\\.2022\\.07\\.014 | "
    "Bacteriophages benefit from mobilizing pathogenicity islands "
    "encoding immune systems against competitors"
)
RULES_SNIPPET = "FS_Sma\tFS_Sma\t1\t1\tFS_Sma__Sma"
SMA_HMM_ROW = (
    "| FS_Sma__Sma                                      | "
    "FS_Sma__Sma                                      | "
    "FS_Sma                 | Custom                  | 100    |"
...
def article_registry_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder article registry maps the named FS_Sma system "
...
def rules_evidence() -> dict[str, str]:
    return {
        ...
        "notes": (
            "The DefenseFinder rules table models FS_Sma as a single-profile "
            "system requiring the FS_Sma__Sma profile."
        ),
    }


def sma_hmm_evidence() -> dict[str, str]:
    return {
        "reference": DEFENSEFINDER_HMMS,
        "snippet": SMA_HMM_ROW,
        "notes": (
            "The DefenseFinder HMM inventory records FS_Sma__Sma under FS_Sma."
        ),
    }
...
RECORD: dict[str, Any] = {
    ...
    "label": "FS-Sma system",
    "definition": (
        "A phage defense system in which an organism possesses an FS_Sma "
        "locus represented by DefenseFinder as a single-profile model "
        "requiring FS_Sma__Sma."
    ),
    ...
    "causal_graphs": [
        {
            "graph_id": "fs_sma_locus_restricts_phage",
            "title": "FS-Sma loci confer bacterial phage defense",
            "description": (
                "Conservative system-level sketch linking possession of an "
                "FS_Sma locus to broad mobile-element defense without "
                "asserting the unresolved phage trigger or molecular output."
            ),
            "scope_status": "NONMECHANISTIC",
            "scope_notes": (
                "The graph captures FS-Sma as a named DefenseFinder "
                "single-profile system in the Fillol-Salom PICI defense "
                "family while leaving its natural host breadth, helper-phage "
                "trigger, Sma component identity, and direct effector activity "
                "unresolved."
            ),
            "nodes": [
                {
                    "node_id": "fs_sma_locus",
                    "label": "FS_Sma locus",
                    "node_type": "GENETIC_ELEMENT",
                    "description": (
                        "A DefenseFinder FS_Sma phage-defense locus represented "
                        "by a custom FS_Sma__Sma profile."
                    ),
                },
                {
                ...
                },
                {
                    ...
                    "description": (
                        "Possession of a genome-encoded FS-Sma phage-defense "
                        "system."
                    ),
                },
                {
            ...
            "edges": [
                {
                    "subject": "fs_sma_locus",
                    "predicate": "contributes to",
                    "predicate_id": "RO:0002326",
                    "object": "pici_encoded_mobile_element_defense",
                    "description": (
                        "DefenseFinder maps FS_Sma to the Fillol-Salom et al. "
                        "PICI-encoded immunity study and models it as a "
                        "single-profile system requiring a custom FS_Sma__Sma "
                        "profile."
                    ),
                    "evidence": [
                        {
                ...
                },
                {
                    ...
                    "description": (
                        "FS_Sma-associated mobile-element defense realizes the "
                        "FS-Sma system trait."
                    ),
                    "evidence": [
                        {
                ...
                },
                {
                    ...
                    "description": (
                        "FS-Sma system possession is a phage-defense-system "
                        "trait."
                    ),
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve FS_Sma natural hosts, helper-phage triggers, Sma "
                "component identity, and effector activity before minting "
                "narrower FS_Sma mechanism children."
            ),
            "kind": "KNOWLEDGE_GAP",
            "status": "OPEN",
            "rationale": (
                ...
                "immunity, and DefenseFinder models FS_Sma as a "
                "single-profile system. Its exact natural host breadth, "
                "helper-phage trigger, component identity, and "
                "profile-to-activity mapping remain unresolved."
            ),
            "attaches_to": ["causal_graphs#fs_sma_locus_restricts_phage"],
            "posed_by": CURATOR,
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted FS-Sma system as a DOI-backed GENOMICS TraitRecord under "
