#!/usr/bin/env python3
"""Add the Nantosuelta system genomics trait."""
...
TARGET = REPO_ROOT / "data" / "traits" / "genomics" / "nantosuelta_system.yaml"
...
CURATOR = "codex"
TIMESTAMP = "2026-09-19T15:29:21Z"

IDENTIFIER = "traitmech:000284"
SYSTEM = "Nantosuelta"
SLUG = "nantosuelta"
PROFILE = "VCA0322"
PROPOSAL = "proposals/metpo_traitmech_v161"
EMPTY_HMM_NAME = ""
            ...
            "nodes": [
                {
                    ...
                    "description": (
                        f"A {SYSTEM} anti-phage defense locus represented "
