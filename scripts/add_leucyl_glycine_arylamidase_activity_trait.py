#!/usr/bin/env python3
"""Add leucyl glycine arylamidase activity with DOI-backed evidence."""
...
TARGET = REPO_ROOT / "data" / "traits" / "physiology" / (
    "leucyl_glycine_arylamidase_activity.yaml"
)
AMYGDALOBACTER = "DOI:10.1099/ijsem.0.006017"
ACTINOMYCES = "DOI:10.1128/JCM.40.9.3427-3431.2002"
CURATOR = "codex"
TIMESTAMP = "2026-09-14T00:53:00Z"

RECORD = {
    "identifier": "traitmech:000178",
    "label": "leucyl glycine arylamidase activity",
    "definition": (
    ...
    "synonyms": [
        {
            "synonym_text": "leucyl glycine arylamidase",
            "synonym_type": "RELATED_SYNONYM",
            "source": AMYGDALOBACTER,
        },
        {
            "synonym_text": "leucylglycine arylamidase",
            "synonym_type": "RELATED_SYNONYM",
            "source": ACTINOMYCES,
        },
    ],
    "evidence": [
        {
            ...
            "notes": (
                "Srinivasan et al. listed leucyl glycine arylamidase among "
        ...
        },
        {
            ...
            "notes": (
                "Hall et al. reported leucylglycine arylamidase activity in "
    ...
    "canonical_examples": [
        {
            ...
            "note": (
                ...
                "positive for leucyl glycine arylamidase activity in an "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve an exact external ontology class for leucyl glycine "
            ...
            "rationale": (
                ...
                "exact leucyl-glycine-specific arylamidase production "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted leucyl glycine arylamidase activity as a DOI-backed "
            "TraitRecord after a repository-wide duplicate review covering "
            "ignored and hidden files; METPO has no exact leucyl glycine "
            "arylamidase activity class yet and the placeholder is reserved "
            "in proposals/metpo_traitmech_v55."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
