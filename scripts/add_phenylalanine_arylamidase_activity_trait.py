#!/usr/bin/env python3
"""Add phenylalanine arylamidase activity with DOI-backed evidence."""
...
TARGET = REPO_ROOT / "data" / "traits" / "physiology" / (
    "phenylalanine_arylamidase_activity.yaml"
)
AMYGDALOBACTER = "DOI:10.1099/ijsem.0.006017"
ACTINOMYCES = "DOI:10.1128/JCM.40.9.3427-3431.2002"
CURATOR = "codex"
TIMESTAMP = "2026-09-12T12:08:46Z"

RECORD = {
    "identifier": "traitmech:000168",
    "label": "phenylalanine arylamidase activity",
    "definition": (
        "A physiological enzyme-activity phenotype in which a cell produces "
        "active phenylalanine arylamidase enzymes that hydrolyze "
        "phenylalanine arylamide substrates."
    ),
    ...
    "synonyms": [
        {
            "synonym_text": "phenylalanine arylamidase",
    ...
    "evidence": [
        ...
        },
        {
            ...
            "notes": (
                "Hall et al. reported phenylalanine arylamidase activity in "
                "all eight Actinomyces cardiffensis clinical isolates tested "
                "with the API rapid ID32A system."
            ),
        }
    ],
    "canonical_examples": [
        {
            ...
            "note": (
                ...
                "positive for phenylalanine arylamidase activity in an "
    ...
    "discussions": [
        {
            ...
            "prompt": (
                "Resolve an exact external ontology class for phenylalanine "
            ...
            "rationale": (
                ...
                "exact residue-specific phenylalanine arylamidase production "
...
def main() -> int:
    ...
    record_curation_event(
        ...
        changes=(
            "Minted phenylalanine arylamidase activity as a DOI-backed "
            "TraitRecord after a repository-wide duplicate review covering "
            "ignored and hidden files; METPO has no exact phenylalanine "
            "arylamidase activity class yet and the placeholder is reserved "
            "in proposals/metpo_traitmech_v45."
        ),
        llm_assisted=True,
        timestamp=TIMESTAMP,
    )
