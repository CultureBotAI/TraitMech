window.searchData = [
 ...
 },
 {
  ...
  "prompt": "Resolve the direct SP\u00df YonE trigger, SpbK TIR-domain output, essential host target, and broader SpbK homolog scope before minting narrower SpbK mechanism children.",
  "kind": "KNOWLEDGE_GAP",
  "status": "OPEN",
  "is_gap": "Knowledge gap",
  ...
  "rationale": "Johnson et al. support ICEBs1 spbK as a YonE-dependent abortive infection gene that inhibits SP\u00df and causes cell death, and DefenseFinder maps SpbK to the SpbK__SpbK profile. The direct SpbK-YonE coupling event, TIR-domain output, essential host target, and homolog breadth remain unresolved.",
  "num_experiments": 0,
  "num_evidence": 0,
  "evidence_refs": [],
  "posed_by": "codex",
