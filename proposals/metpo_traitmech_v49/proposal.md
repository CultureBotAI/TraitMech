# METPO ROBOT Template Proposal - Serine Arylamidase Activity (v49, 2026-09)

> **Upstream submission:** to be consolidated into
> [berkeleybop/metpo#535](https://github.com/berkeleybop/metpo/issues/535)
> alongside the v1-v48 cohorts, requesting a real METPO ID for this Scope-A
> `traitmech:` fallback.
...
already carries catalase, oxidase, urease, and coagulase activity; serine
...
|---|---:|---|
| A - synthetic trait class lift | 1 | `traitmech:000172` was minted locally because METPO has no equivalent serine arylamidase activity class |
| B - causal-graph predicate lift | 0 | no predicates are proposed |
| C - schema enum lift | 0 | no schema vocabulary is proposed |

## ID Block

`METPO:1012600` is reserved for this one-row class cohort. The v48 cohort used
`METPO:1012500`, so v49 starts at the next hundred block to keep cohorts
...
scripts, tests, and ignored/hidden files. `METPO:1012600` appeared only in
the v48 next-block reservation note, no prior proposal reserved
`metpo_traitmech_v49`, and no `traitmech:000172` or serine arylamidase
...
| ID | label | parent |
|---|---|---|
| `METPO:1012600` | serine arylamidase activity | `METPO:1000059` phenotype |

Serine arylamidase activity is parallel to the existing diagnostic-enzyme
...
tyrosine, glycine, histidine, prolyl, and pyrrolidonyl arylamidase activity,
...
where a cell produces active serine arylamidase enzymes that hydrolyze serine
arylamide substrates.

## External Mappings

No exact external mapping is proposed. `GO:0004177` names the broader
aminopeptidase molecular function rather than the organism-level serine
arylamidase production phenotype, so it remains a close causal-node grounding
lead and not an equivalent TraitRecord xref.

The source phrase `serine arylamidase` names an enzyme or diagnostic panel row
...
2. On mint, replace local `traitmech:000172` with the assigned `METPO:` CURIE.
3. Preserve `traitmech:000172` as traceability during the migration.

## Change Log

- v49, 2026-09: lifts `traitmech:000172 serine arylamidase activity` into
  the `METPO:1012600` block.
