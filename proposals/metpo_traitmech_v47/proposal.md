# METPO ROBOT Template Proposal - Glycine Arylamidase Activity (v47, 2026-09)

> **Upstream submission:** to be consolidated into
> [berkeleybop/metpo#535](https://github.com/berkeleybop/metpo/issues/535)
> alongside the v1-v46 cohorts, requesting a real METPO ID for this Scope-A
> `traitmech:` fallback.
...
already carries catalase, oxidase, urease, and coagulase activity; glycine
...
|---|---:|---|
| A - synthetic trait class lift | 1 | `traitmech:000170` was minted locally because METPO has no equivalent glycine arylamidase activity class |
| B - causal-graph predicate lift | 0 | no predicates are proposed |
| C - schema enum lift | 0 | no schema vocabulary is proposed |

## ID Block

`METPO:1012400` is reserved for this one-row class cohort. The v46 cohort used
`METPO:1012300`, so v47 starts at the next hundred block to keep cohorts
...
scripts, tests, and ignored/hidden files. `METPO:1012400` appeared only in
the v46 next-block reservation note, no prior proposal reserved
`metpo_traitmech_v47`, and no `traitmech:000170` or glycine arylamidase
...
| ID | label | parent |
|---|---|---|
| `METPO:1012400` | glycine arylamidase activity | `METPO:1000059` phenotype |

Glycine arylamidase activity is parallel to the existing diagnostic-enzyme
...
tyrosine, prolyl, and pyrrolidonyl arylamidase activity, alpha-glucosidase
...
where a cell produces active glycine arylamidase enzymes that hydrolyze glycine
arylamide substrates.

## External Mappings

No exact external mapping is proposed. `GO:0004177` names the broader
aminopeptidase molecular function rather than the organism-level glycine
arylamidase production phenotype, so it remains a close causal-node grounding
lead and not an equivalent TraitRecord xref.

The source phrase `glycine arylamidase` names an enzyme or diagnostic panel row
...
2. On mint, replace local `traitmech:000170` with the assigned `METPO:` CURIE.
3. Preserve `traitmech:000170` as traceability during the migration.

## Change Log

- v47, 2026-09: lifts `traitmech:000170 glycine arylamidase activity` into
  the `METPO:1012400` block.
