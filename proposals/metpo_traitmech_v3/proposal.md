...
covering **54 nodes**, plus 1 GO mapping
(`carotenoid biosynthesis` → `GO:0016117`, 4 more nodes) and 1
dual-typing alias row for `terminal electron acceptor` — a total
of **8 new mapping rows / 58 newly-grounded nodes** (9% of the
residual at v2-merge time).
...
with `microbial biomass` in fermentative disproportionation. The
...
8 new mappings: 6 METPO classes + 1 GO mapping for carotenoid
biosynthesis + 1 dual-typing alias for terminal electron acceptor
