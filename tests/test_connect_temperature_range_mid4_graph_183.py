"""Regression tests for the temperature-range-mid4 component repair in issue #183."""
...
from connect_temperature_range_mid4_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_endpoint():
    ...
    doc["causal_graphs"][0]["nodes"] = [
        ...
        if node["node_id"] != "homeoviscous_adaptation"
    ]
