"""Regression tests for the NaCl-optimum component repair in issue #183."""
...
from connect_nacl_optimum_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_endpoint():
    ...
    doc["causal_graphs"][0]["nodes"] = [
        node for node in doc["causal_graphs"][0]["nodes"] if node["node_id"] != "osmotic_balance"
    ]
