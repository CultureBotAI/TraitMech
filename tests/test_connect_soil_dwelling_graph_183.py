"""Regression tests for the soil_dwelling component repair in issue #183."""
...
import connect_soil_dwelling_graph_183 as migration  # noqa: E402
from connect_soil_dwelling_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    ADDED_NODES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_added_endpoint(monkeypatch: pytest.MonkeyPatch):
    doc = _before()
    monkeypatch.setattr(migration, "ADDED_NODES", [])
