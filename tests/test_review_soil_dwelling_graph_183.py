"""Regression tests for the soil_dwelling ecology review in issue #183."""
...
from review_soil_dwelling_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    NODE_REPLACEMENTS,
...
def test_review_adds_snippets_and_regrounds_broad_associations():
    ...
    assert {edge["predicate"] for edge in graph["edges"]}.isdisjoint(
        {"enriches for", "increases prevalence of", "predicts"}
    )
