"""Regression tests for the temperature-optimum-high component repair in issue #183."""
...
from connect_temperature_optimum_high_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_endpoint():
    ...
    doc["causal_graphs"][0]["nodes"] = [
        ...
        if node["node_id"] != "thermophile_thermostability"
    ]
