"""Regression tests for the temperature-delta-high component repair in issue #183."""
...
from connect_temperature_delta_high_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_endpoint():
    ...
    doc["causal_graphs"][0]["nodes"] = [
        ...
        if node["node_id"] != "maximal_thermal_adaptation"
    ]
