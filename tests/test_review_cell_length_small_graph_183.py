"""Regression tests for the cell_length_small review in issue #183."""
...
from review_cell_length_small_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    NODE_REPLACEMENTS,
    SLUG,
...
def test_review_adds_snippets_and_grounds_cell_length_small_edges():
    ...
    assert nodes["ftsz_abundance"]["node_type"] == "QUALITY"
    assert "grounding_status" not in nodes["ftsz_abundance"]
    assert {
        ("ftsz_abundance", "rate_limiting_for", "division_timing"),
        ("ftsz_protoring", "organizes", "divisome_assembly"),
        ("min_nucleoid_occlusion", "positions", "ftsz_midcell_positioning"),
    }.isdisjoint(by_key)
