"""Regression tests for the pH-delta-mid3 component repair in issue #183."""
...
from connect_ph_delta_mid3_graph_183 import (  # noqa: E402
    ACTION,
    ADDED_EDGES,
    EXPECTED_COMPONENTS,
...
def test_refuses_missing_endpoint():
    ...
    doc["causal_graphs"][0]["nodes"] = [
        ...
        if node["node_id"] != "wide_ph_homeostasis"
    ]
