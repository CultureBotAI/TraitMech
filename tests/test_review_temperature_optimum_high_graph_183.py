"""Regression tests for the temperature-optimum-high review in issue #183."""
...
from review_temperature_optimum_high_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    SLUG,
    TIMESTAMP,
...
def test_review_adds_snippets_and_grounds_thermophile_edges():
    ...
    assert {
        ("thermosome", "refolds", "denatured_protein_refolding"),
        ("membrane_lipid_composition", "stabilizes", "membrane_thermostability"),
    }.isdisjoint(by_key)
...
def test_refuses_partial_replay():
    doc = _before()
    graph = doc["causal_graphs"][0]
    replacement = EDGE_REPLACEMENTS[4]
