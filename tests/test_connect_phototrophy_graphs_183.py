"""Regression tests for the five phototrophy repairs in #183."""
...
from connect_phototrophy_graphs_183 import (  # noqa: E402
    ACTION,
    ADDITIONS,
    EXPECTED_COMPONENTS,
    _components,
...
def test_refuses_partial_replay():
    slug = "physiology/photoorganoheterotrophic"
    doc = _before(slug)
