"""Regression tests for three two-component physiology repairs in #183."""
...
from connect_physiology_contrast_graphs_183 import (  # noqa: E402
    ACTION,
    ADDITIONS,
    EXPECTED_COMPONENTS,
    _components,
