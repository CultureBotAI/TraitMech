"""Regression tests for the mesophilic environment review in issue #183."""
...
from review_mesophilic_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    SLUG,
    TIMESTAMP,
...
def test_review_adds_snippets_and_regrounds_heat_cold_edges():
    ...
    assert {
        ("cold_shock", "induces", "cspa"),
        ("heat_shock", "induces", "rpoh_sigma32"),
        ("rpoh_sigma32", "activates expression of", "heat_shock_proteins"),
    }.isdisjoint(by_key)
