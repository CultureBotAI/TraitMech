"""Regression tests for the saprotrophy review in issue #183."""
...
from review_saprotrophy_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
...
def test_review_adds_snippets_to_saprotrophy_edges():
