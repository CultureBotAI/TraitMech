"""Regression tests for the ph_delta_mid2 environment review in issue #183."""
...
from review_ph_delta_mid2_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    SLUG,
    TIMESTAMP,
...
def test_review_adds_snippets_and_grounds_ph_homeostasis_edges():
    ...
    assert {
        ("external_ph_stress", "alters", "pmf_component_balance"),
        ("na_h_antiporter_activity", "supports", "alkaline_ph_homeostasis"),
        ("cytoplasmic_buffers", "buffers", "cytoplasmic_ph_buffering"),
    }.isdisjoint(by_key)
