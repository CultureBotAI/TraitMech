...
def test_an_unrelated_label_is_drift():
    verdict, canonical, score = classify("ectoine", "| ectoine | CHEBI:10357 |",
...
def test_an_obsolete_term_is_flagged_even_when_the_label_matches():
    ...
    verdict, _, _ = classify("pathogenesis", "| row |",
