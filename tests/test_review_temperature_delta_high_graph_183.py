"""Regression tests for the temperature-delta-high review in issue #183."""
...
from review_temperature_delta_high_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    SLUG,
    TIMESTAMP,
...
def test_review_adds_snippets_and_grounds_thermal_edges():
    ...
    assert {
        ("homoviscous_adaptation", "maintains", "membrane_fluidity_homeostasis"),
        (
            "decreased_membrane_fluidity",
            "upregulates",
            "unsaturated_fatty_acid_biosynthesis",
        ),
        ("thermostable_enzyme", "resists", "irreversible_protein_inactivation"),
    }.isdisjoint(by_key)
