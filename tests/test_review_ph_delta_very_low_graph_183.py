"""Regression tests for the ph_delta_very_low environment review in issue #183."""
...
from review_ph_delta_very_low_graph_183 import (  # noqa: E402
    ACTION,
    EDGE_REPLACEMENTS,
    SLUG,
    TIMESTAMP,
...
def test_review_adds_snippets_and_grounds_ph_homeostasis_edges():
    ...
    assert {
        ("external_ph_stress", "alters", "pmf_partitioning"),
        (
            "constitutive_ph_homeostasis_expression",
            "imposes energetic cost on",
            "energetic_cost",
        ),
        ("na_h_antiporter_activity", "enables", "alkaline_ph_homeostasis"),
        ("f1fo_atpase_proton_pumping", "promotes", "acid_stress_survival"),
        (
            "glutamate_decarboxylase_system",
            "consumes",
            "cytoplasmic_proton_consumption",
        ),
    }.isdisjoint(by_key)
