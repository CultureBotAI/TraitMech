"""Regression tests for four remaining physiology graph repairs in #183."""
...
from connect_remaining_physiology_graphs_183 import (  # noqa: E402
    ACTION,
    ADDITIONS,
    EXPECTED_COMPONENTS,
    _components,
...
def test_refuses_partial_replay():
    slug = "physiology/antibiotic_resistance"
    doc = _before(slug)
...
def test_refuses_connector_drift():
    slug = "physiology/natural_competence"
    doc = _current(slug)
