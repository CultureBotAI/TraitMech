...
`PROPOSED`, and twenty-two records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and fifteen other).
...
│   └── traits/<category>/<slug>.yaml    # 519 curated TraitRecords
