...
forty-eight physiology records, 136 genomics records, and one other
...
other).
Across the corpus, 495 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 739 curated TraitRecords
