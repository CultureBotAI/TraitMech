...
forty physiology records are `PROPOSED`, and thirty-one records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and twenty-four other).
...
│   └── traits/<category>/<slug>.yaml    # 564 curated TraitRecords
