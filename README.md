...
forty-eight physiology records, 176 genomics records, and one other
...
other).
Across the corpus, 535 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 779 curated TraitRecords
