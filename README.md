...
forty-eight physiology records, 132 genomics records, and one other
...
other).
Across the corpus, 491 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 735 curated TraitRecords
