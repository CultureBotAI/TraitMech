...
forty-eight physiology records, one hundred genomics records, and one other
...
other).
Across the corpus, 459 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 703 curated TraitRecords
