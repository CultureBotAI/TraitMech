...
`PROPOSED`, and twelve records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and five other).
...
│   └── traits/<category>/<slug>.yaml    # 509 curated TraitRecords
