...
forty-eight physiology records, twenty-three genomics records, and one other
...
other).
Across the corpus, 382 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 626 curated TraitRecords
