...
forty-eight physiology records, fifty-nine genomics records, and one other
...
other).
Across the corpus, 418 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 662 curated TraitRecords
