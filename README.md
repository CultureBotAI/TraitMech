...
forty-eight physiology records, twenty-eight genomics records, and one other
...
other).
Across the corpus, 387 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 631 curated TraitRecords
