...
forty-eight physiology records, forty-nine genomics records, and one other
...
other).
Across the corpus, 408 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 652 curated TraitRecords
