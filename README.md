...
forty-eight physiology records, forty-one genomics records, and one other
...
other).
Across the corpus, 400 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 644 curated TraitRecords
