...
`PROPOSED`, and thirteen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and six other).
...
│   └── traits/<category>/<slug>.yaml    # 510 curated TraitRecords
