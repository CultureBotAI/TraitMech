...
forty-eight physiology records, 148 genomics records, and one other
...
other).
Across the corpus, 507 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 751 curated TraitRecords
