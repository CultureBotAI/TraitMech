...
forty-eight physiology records, fifty genomics records, and one other
...
other).
Across the corpus, 409 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 653 curated TraitRecords
