...
- **TraitCategoryEnum** — 11 schema buckets (the 10 populated buckets above,
  plus `DETECTION`).
...
│   └── traits/<category>/<slug>.yaml    # 588 curated TraitRecords
