...
forty-eight physiology records, eighty-one genomics records, and one other
...
other).
Across the corpus, 440 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 684 curated TraitRecords
