...
forty-eight physiology records, twenty-five genomics records, and one other
...
other).
Across the corpus, 384 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 628 curated TraitRecords
