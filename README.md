...
forty-eight physiology records, 112 genomics records, and one other
...
other).
Across the corpus, 471 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 715 curated TraitRecords
