...
forty-eight physiology records, 175 genomics records, and one other
...
other).
Across the corpus, 534 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 778 curated TraitRecords
