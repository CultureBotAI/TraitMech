...
forty-eight physiology records, twenty-two genomics records, and one other
...
other).
Across the corpus, 381 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 625 curated TraitRecords
