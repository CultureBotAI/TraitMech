...
forty-eight physiology records, forty-two genomics records, and one other
...
other).
Across the corpus, 401 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 645 curated TraitRecords
