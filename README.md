...
forty-eight physiology records, sixty-eight genomics records, and one other
...
other).
Across the corpus, 427 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 671 curated TraitRecords
