...
forty-eight physiology records, eighteen genomics records, and one other
...
other).
Across the corpus, 377 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 621 curated TraitRecords
