...
forty-eight physiology records, 139 genomics records, and one other
...
other).
Across the corpus, 498 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 742 curated TraitRecords
