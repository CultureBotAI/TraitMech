...
forty-eight physiology records, 104 genomics records, and one other
...
other).
Across the corpus, 463 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 707 curated TraitRecords
