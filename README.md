...
forty-eight physiology records, sixty-three genomics records, and one other
...
other).
Across the corpus, 422 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 666 curated TraitRecords
