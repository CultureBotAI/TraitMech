...
`PROPOSED`, and eleven records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and four other).
...
│   └── traits/<category>/<slug>.yaml    # 508 curated TraitRecords
