...
`PROPOSED`, and twenty-three records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and sixteen other).
...
│   └── traits/<category>/<slug>.yaml    # 520 curated TraitRecords
