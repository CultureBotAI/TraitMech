...
forty-eight physiology records, 181 genomics records, and one other
...
other).
Across the corpus, 540 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 784 curated TraitRecords
