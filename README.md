...
forty-eight physiology records, 109 genomics records, and one other
...
other).
Across the corpus, 468 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 712 curated TraitRecords
