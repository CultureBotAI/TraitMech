...
forty-eight physiology records, 119 genomics records, and one other
...
other).
Across the corpus, 478 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 722 curated TraitRecords
