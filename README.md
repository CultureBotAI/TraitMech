...
forty-eight physiology records, 147 genomics records, and one other
...
other).
Across the corpus, 506 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 750 curated TraitRecords
