...
forty-eight physiology records, 114 genomics records, and one other
...
other).
Across the corpus, 473 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 717 curated TraitRecords
