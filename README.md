...
`PROPOSED`, and twenty-four records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and seventeen other).
...
│   └── traits/<category>/<slug>.yaml    # 521 curated TraitRecords
