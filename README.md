...
forty-eight physiology records, 142 genomics records, and one other
...
other).
Across the corpus, 501 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 745 curated TraitRecords
