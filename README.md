...
forty-eight physiology records, eighty-four genomics records, and one other
...
other).
Across the corpus, 443 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 687 curated TraitRecords
