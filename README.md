...
forty-eight physiology records, 179 genomics records, and one other
...
other).
Across the corpus, 538 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 782 curated TraitRecords
