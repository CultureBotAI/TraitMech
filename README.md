...
forty physiology records are `PROPOSED`, and thirty-two records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and twenty-five other).
...
│   └── traits/<category>/<slug>.yaml    # 565 curated TraitRecords
