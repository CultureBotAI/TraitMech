...
forty-eight physiology records, 124 genomics records, and one other
...
other).
Across the corpus, 483 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 727 curated TraitRecords
