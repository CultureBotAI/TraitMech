...
forty-eight physiology records, 126 genomics records, and one other
...
other).
Across the corpus, 485 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 729 curated TraitRecords
