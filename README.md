...
forty-eight physiology records, 174 genomics records, and one other
...
other).
Across the corpus, 533 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 777 curated TraitRecords
