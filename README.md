...
forty-eight physiology records, fifty-four genomics records, and one other
...
other).
Across the corpus, 413 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 657 curated TraitRecords
