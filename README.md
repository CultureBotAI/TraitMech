...
`PROPOSED`, and three records are still `SEEDED` (one metabolism, one
physiology, and one other).
...
│   └── traits/<category>/<slug>.yaml    # 500 curated TraitRecords
