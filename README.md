...
forty-eight physiology records, 143 genomics records, and one other
...
other).
Across the corpus, 502 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 746 curated TraitRecords
