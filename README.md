...
forty-eight physiology records, twenty-seven genomics records, and one other
...
other).
Across the corpus, 386 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 630 curated TraitRecords
