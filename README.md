...
forty-eight physiology records, 172 genomics records, and one other
...
other).
Across the corpus, 531 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 775 curated TraitRecords
