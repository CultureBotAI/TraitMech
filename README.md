...
`PROPOSED`, and fifteen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and eight other).
...
│   └── traits/<category>/<slug>.yaml    # 512 curated TraitRecords
