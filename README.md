...
forty-eight physiology records, thirty-eight genomics records, and one other
...
other).
Across the corpus, 397 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 640 curated TraitRecords
