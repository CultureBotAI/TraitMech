...
forty-eight physiology records, ninety-one genomics records, and one other
...
other).
Across the corpus, 450 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 694 curated TraitRecords
