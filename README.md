...
forty-eight physiology records, fifty-three genomics records, and one other
...
other).
Across the corpus, 412 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 656 curated TraitRecords
