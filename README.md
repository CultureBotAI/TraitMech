...
forty-eight physiology records, 137 genomics records, and one other
...
other).
Across the corpus, 496 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 740 curated TraitRecords
