...
forty-eight physiology records, eighty-seven genomics records, and one other
...
other).
Across the corpus, 446 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 690 curated TraitRecords
