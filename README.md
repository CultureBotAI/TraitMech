...
forty-eight physiology records, 173 genomics records, and one other
...
other).
Across the corpus, 532 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 776 curated TraitRecords
