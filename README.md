...
forty-eight physiology records, ninety-nine genomics records, and one other
...
other).
Across the corpus, 458 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 702 curated TraitRecords
