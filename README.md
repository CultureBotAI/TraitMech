...
`PROPOSED`, and nineteen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and twelve other).
...
│   └── traits/<category>/<slug>.yaml    # 516 curated TraitRecords
