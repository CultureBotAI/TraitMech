...
forty-eight physiology records, 158 genomics records, and one other
...
other).
Across the corpus, 517 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 760 curated TraitRecords
