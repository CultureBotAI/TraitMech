...
forty-eight physiology records, thirty-three genomics records, and one other
...
other).
Across the corpus, 392 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 636 curated TraitRecords
