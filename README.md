...
forty-eight physiology records, fifty-five genomics records, and one other
...
other).
Across the corpus, 414 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 658 curated TraitRecords
