...
forty-eight physiology records, 103 genomics records, and one other
...
other).
Across the corpus, 462 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 706 curated TraitRecords
