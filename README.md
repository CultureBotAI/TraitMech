...
forty-eight physiology records, 106 genomics records, and one other
...
other).
Across the corpus, 465 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 708 curated TraitRecords
