...
forty-eight physiology records, 116 genomics records, and one other
...
other).
Across the corpus, 475 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 719 curated TraitRecords
