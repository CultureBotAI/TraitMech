...
forty-eight physiology records, seventy-seven genomics records, and one other
...
other).
Across the corpus, 436 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 680 curated TraitRecords
