...
`PROPOSED`, and eight records are still `SEEDED` (one environment, one metabolism,
three morphology, one physiology, and two other).
...
│   └── traits/<category>/<slug>.yaml    # 505 curated TraitRecords
