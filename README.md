...
forty-eight physiology records, two genomics records, and one other record are `PROPOSED`, and
thirty-eight records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and thirty-one other).
Across the corpus, 361 records currently carry causal graphs. The 50 deprecated
records (23
