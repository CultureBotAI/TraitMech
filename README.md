...
forty-eight physiology records, forty-seven genomics records, and one other
...
other).
Across the corpus, 406 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 650 curated TraitRecords
