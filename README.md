...
forty-eight physiology records, thirty genomics records, and one other
...
other).
Across the corpus, 389 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 633 curated TraitRecords
