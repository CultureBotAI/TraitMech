...
forty-eight physiology records, 128 genomics records, and one other
...
other).
Across the corpus, 487 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 731 curated TraitRecords
