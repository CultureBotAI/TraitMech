...
forty-eight physiology records, 144 genomics records, and one other
...
other).
Across the corpus, 503 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 747 curated TraitRecords
