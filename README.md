...
forty-eight physiology records, 184 genomics records, and one other
...
other).
Across the corpus, 543 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 787 curated TraitRecords
