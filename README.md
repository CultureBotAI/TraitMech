...
forty-eight physiology records, sixty-seven genomics records, and one other
...
other).
Across the corpus, 426 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 670 curated TraitRecords
