...
forty-eight physiology records, thirty-six genomics records, and one other
...
other).
Across the corpus, 395 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 639 curated TraitRecords
