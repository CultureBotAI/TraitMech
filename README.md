...
forty-eight physiology records, 145 genomics records, and one other
...
other).
Across the corpus, 504 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 748 curated TraitRecords
