...
| OTHER | 0 | 0 | 0 | 0 | 22 |
| **TOTAL** | **427** | **48** | **50** | **353** | **554** |

477 records have a terminal curation status: 427 are `REVIEWED` and 50 are
`DEPRECATED`; 15 newer metabolism records and thirty-three physiology records are
...
│   └── traits/<category>/<slug>.yaml    # 554 curated TraitRecords
