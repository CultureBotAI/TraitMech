...
forty-eight physiology records, 171 genomics records, and one other
...
other).
Across the corpus, 530 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 774 curated TraitRecords
