...
forty-eight physiology records, 167 genomics records, and one other
...
other).
Across the corpus, 526 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 770 curated TraitRecords
