...
forty-eight physiology records, 159 genomics records, and one other
...
other).
Across the corpus, 518 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 762 curated TraitRecords
