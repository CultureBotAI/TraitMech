...
forty-eight physiology records, sixty-five genomics records, and one other
...
other).
Across the corpus, 424 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 668 curated TraitRecords
