...
forty physiology records are `PROPOSED`, and thirty-three records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and twenty-six other).
...
│   └── traits/<category>/<slug>.yaml    # 566 curated TraitRecords
