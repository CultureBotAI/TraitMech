...
forty-eight physiology records, fifty-six genomics records, and one other
...
other).
Across the corpus, 415 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 659 curated TraitRecords
