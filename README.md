...
forty-eight physiology records, sixty-two genomics records, and one other
...
other).
Across the corpus, 421 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 665 curated TraitRecords
