...
forty-eight physiology records, seventy-six genomics records, and one other
...
other).
Across the corpus, 435 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 679 curated TraitRecords
