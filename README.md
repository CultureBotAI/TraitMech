...
forty-eight physiology records, seventy-four genomics records, and one other
...
other).
Across the corpus, 433 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 677 curated TraitRecords
