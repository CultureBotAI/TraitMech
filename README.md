...
forty-eight physiology records, seventy-one genomics records, and one other
...
other).
Across the corpus, 430 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 674 curated TraitRecords
