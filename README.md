...
forty-eight physiology records, 118 genomics records, and one other
...
other).
Across the corpus, 477 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 721 curated TraitRecords
