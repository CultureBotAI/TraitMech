...
forty-eight physiology records, 155 genomics records, and one other
...
other).
Across the corpus, 514 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 758 curated TraitRecords
