...
forty-eight physiology records, 169 genomics records, and one other
...
other).
Across the corpus, 528 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 772 curated TraitRecords
