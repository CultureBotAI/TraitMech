...
forty-eight physiology records, ninety genomics records, and one other
...
other).
Across the corpus, 449 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 693 curated TraitRecords
