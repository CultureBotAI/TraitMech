...
forty-eight physiology records, 182 genomics records, and one other
...
other).
Across the corpus, 541 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 785 curated TraitRecords
