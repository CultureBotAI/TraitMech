...
`PROPOSED`, and seventeen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and ten other).
...
│   └── traits/<category>/<slug>.yaml    # 514 curated TraitRecords
