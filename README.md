...
forty-eight physiology records, 123 genomics records, and one other
...
other).
Across the corpus, 482 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 726 curated TraitRecords
