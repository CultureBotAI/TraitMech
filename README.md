...
forty-eight physiology records, twenty genomics records, and one other
...
other).
Across the corpus, 379 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 623 curated TraitRecords
