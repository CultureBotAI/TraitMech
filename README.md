...
forty-eight physiology records, 160 genomics records, and one other
...
other).
Across the corpus, 519 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 763 curated TraitRecords
