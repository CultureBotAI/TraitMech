...
forty-eight physiology records, eighty-six genomics records, and one other
...
other).
Across the corpus, 445 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 689 curated TraitRecords
