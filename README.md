...
`PROPOSED`, and twenty records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and thirteen other).
...
│   └── traits/<category>/<slug>.yaml    # 517 curated TraitRecords
