...
forty-eight physiology records, forty genomics records, and one other
...
other).
Across the corpus, 399 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 643 curated TraitRecords
