...
forty-eight physiology records, sixty-four genomics records, and one other
...
other).
Across the corpus, 423 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 667 curated TraitRecords
