...
forty-eight physiology records, 151 genomics records, and one other
...
other).
Across the corpus, 510 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 754 curated TraitRecords
