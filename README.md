...
forty-eight physiology records, 163 genomics records, and one other
...
other).
Across the corpus, 522 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 766 curated TraitRecords
