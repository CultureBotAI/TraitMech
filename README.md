...
`PROPOSED`, and twenty-one records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and fourteen other).
...
│   └── traits/<category>/<slug>.yaml    # 518 curated TraitRecords
