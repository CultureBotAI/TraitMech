...
forty-eight physiology records, 161 genomics records, and one other
...
other).
Across the corpus, 520 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 764 curated TraitRecords
