...
forty-eight physiology records, 154 genomics records, and one other
...
other).
Across the corpus, 513 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 757 curated TraitRecords
