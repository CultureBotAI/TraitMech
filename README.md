...
forty-eight physiology records, 125 genomics records, and one other
...
other).
Across the corpus, 484 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 728 curated TraitRecords
