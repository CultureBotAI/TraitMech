...
forty-eight physiology records, 138 genomics records, and one other
...
other).
Across the corpus, 497 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 741 curated TraitRecords
