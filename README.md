...
forty physiology records are `PROPOSED`, and thirty-five records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and twenty-eight other).
...
│   └── traits/<category>/<slug>.yaml    # 568 curated TraitRecords
