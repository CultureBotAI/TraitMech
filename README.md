...
forty-eight physiology records, fifty-one genomics records, and one other
...
other).
Across the corpus, 410 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 654 curated TraitRecords
