...
forty-eight physiology records, 177 genomics records, and one other
...
other).
Across the corpus, 536 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 780 curated TraitRecords
