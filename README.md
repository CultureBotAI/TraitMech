...
`PROPOSED`, and fourteen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and seven other).
...
│   └── traits/<category>/<slug>.yaml    # 511 curated TraitRecords
