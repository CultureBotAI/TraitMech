...
| OTHER | 0 | 0 | 0 | 0 | 22 |
| **TOTAL** | **427** | **27** | **50** | **353** | **533** |

477 records have a terminal curation status: 427 are `REVIEWED` and 50 are
`DEPRECATED`; 15 newer metabolism records and twelve physiology records are
...
│   └── traits/<category>/<slug>.yaml    # 533 curated TraitRecords
