...
forty physiology records are `PROPOSED`, and thirty-seven records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and thirty other).
...
│   └── traits/<category>/<slug>.yaml    # 570 curated TraitRecords
