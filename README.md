...
forty-eight physiology records, 115 genomics records, and one other
...
other).
Across the corpus, 474 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 718 curated TraitRecords
