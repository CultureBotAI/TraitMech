...
forty-eight physiology records, thirty-two genomics records, and one other
...
other).
Across the corpus, 391 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 635 curated TraitRecords
