...
`PROPOSED`, and four records are still `SEEDED` (one metabolism, one
physiology, and two other).
...
│   └── traits/<category>/<slug>.yaml    # 501 curated TraitRecords
