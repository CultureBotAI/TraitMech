...
`PROPOSED`, and seven records are still `SEEDED` (one environment, one metabolism,
two morphology, one physiology, and two other).
...
│   └── traits/<category>/<slug>.yaml    # 504 curated TraitRecords
