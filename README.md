...
forty-eight physiology records, seventy genomics records, and one other
...
other).
Across the corpus, 429 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 673 curated TraitRecords
