...
forty-eight physiology records, ninety-seven genomics records, and one other
...
other).
Across the corpus, 456 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 700 curated TraitRecords
