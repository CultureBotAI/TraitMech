...
forty-eight physiology records, 121 genomics records, and one other
...
other).
Across the corpus, 480 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 724 curated TraitRecords
