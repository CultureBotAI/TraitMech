...
forty-eight physiology records, fifty-two genomics records, and one other
...
other).
Across the corpus, 411 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 655 curated TraitRecords
