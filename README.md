...
forty-eight physiology records, thirty-nine genomics records, and one other
...
other).
Across the corpus, 398 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 642 curated TraitRecords
