...
forty-eight physiology records, 150 genomics records, and one other
...
other).
Across the corpus, 509 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 753 curated TraitRecords
