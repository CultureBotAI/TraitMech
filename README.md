...
forty-eight physiology records, 183 genomics records, and one other
...
other).
Across the corpus, 542 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 786 curated TraitRecords
