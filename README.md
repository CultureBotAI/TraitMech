...
forty-eight physiology records, 140 genomics records, and one other
...
other).
Across the corpus, 499 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 743 curated TraitRecords
