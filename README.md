...
forty-eight physiology records, forty-three genomics records, and one other
...
other).
Across the corpus, 402 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 646 curated TraitRecords
