...
forty-eight physiology records, 135 genomics records, and one other
...
other).
Across the corpus, 494 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 736 curated TraitRecords
