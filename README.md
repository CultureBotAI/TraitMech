...
forty-eight physiology records, 178 genomics records, and one other
...
other).
Across the corpus, 537 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 781 curated TraitRecords
