...
forty-eight physiology records, 156 genomics records, and one other
...
other).
Across the corpus, 515 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 759 curated TraitRecords
