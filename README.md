...
forty-eight physiology records, ninety-two genomics records, and one other
...
other).
Across the corpus, 451 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 695 curated TraitRecords
