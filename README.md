...
forty-eight physiology records, 164 genomics records, and one other
...
other).
Across the corpus, 523 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 767 curated TraitRecords
