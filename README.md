...
forty-eight physiology records, thirty-one genomics records, and one other
...
other).
Across the corpus, 390 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 634 curated TraitRecords
