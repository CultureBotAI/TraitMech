...
forty physiology records are `PROPOSED`, and thirty records are
still `SEEDED` (one environment, one metabolism, four morphology, one
physiology, and twenty-three other).
...
│   └── traits/<category>/<slug>.yaml    # 563 curated TraitRecords
