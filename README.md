...
other).
Across the corpus, 488 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 732 curated TraitRecords
