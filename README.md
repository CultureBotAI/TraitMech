...
forty-eight physiology records, eighty-two genomics records, and one other
...
other).
Across the corpus, 441 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 685 curated TraitRecords
