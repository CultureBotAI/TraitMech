...
forty-eight physiology records, eighty genomics records, and one other
...
other).
Across the corpus, 439 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 683 curated TraitRecords
