...
forty-eight physiology records, 180 genomics records, and one other
...
other).
Across the corpus, 539 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 783 curated TraitRecords
