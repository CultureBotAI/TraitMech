...
forty-eight physiology records, 108 genomics records, and one other
...
other).
Across the corpus, 467 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 711 curated TraitRecords
