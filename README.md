...
forty-eight physiology records, 101 genomics records, and one other
...
other).
Across the corpus, 460 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 704 curated TraitRecords
