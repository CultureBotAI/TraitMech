...
forty-eight physiology records, 162 genomics records, and one other
...
other).
Across the corpus, 521 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 765 curated TraitRecords
