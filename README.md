...
forty-eight physiology records, 149 genomics records, and one other
...
other).
Across the corpus, 508 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 752 curated TraitRecords
