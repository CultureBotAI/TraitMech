...
`PROPOSED`, and ten records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and three other).
...
│   └── traits/<category>/<slug>.yaml    # 507 curated TraitRecords
