...
forty-eight physiology records, twenty-nine genomics records, and one other
...
other).
Across the corpus, 388 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 632 curated TraitRecords
