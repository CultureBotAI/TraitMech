...
forty-eight physiology records, ninety-six genomics records, and one other
...
other).
Across the corpus, 455 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 699 curated TraitRecords
