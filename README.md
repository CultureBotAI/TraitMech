...
forty-eight physiology records, sixty-nine genomics records, and one other
...
other).
Across the corpus, 428 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 672 curated TraitRecords
