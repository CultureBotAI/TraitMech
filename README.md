...
`PROPOSED`, and six records are still `SEEDED` (one environment, one metabolism,
one morphology, one physiology, and two other).
...
│   └── traits/<category>/<slug>.yaml    # 502 curated TraitRecords
