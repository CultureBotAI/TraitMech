...
forty-eight physiology records, 146 genomics records, and one other
...
other).
Across the corpus, 505 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 749 curated TraitRecords
