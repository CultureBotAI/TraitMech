...
forty-eight physiology records, 131 genomics records, and one other
...
other).
Across the corpus, 490 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 734 curated TraitRecords
