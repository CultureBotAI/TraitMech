...
forty-eight physiology records, fifty-eight genomics records, and one other
...
other).
Across the corpus, 417 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 660 curated TraitRecords
