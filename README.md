...
forty-eight physiology records, seventy-eight genomics records, and one other
...
other).
Across the corpus, 437 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 681 curated TraitRecords
