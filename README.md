...
forty-eight physiology records, 110 genomics records, and one other
...
other).
Across the corpus, 469 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 713 curated TraitRecords
