...
forty-eight physiology records, ninety-eight genomics records, and one other
...
other).
Across the corpus, 457 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 701 curated TraitRecords
