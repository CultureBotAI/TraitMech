...
forty-eight physiology records, 102 genomics records, and one other
...
other).
Across the corpus, 461 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 705 curated TraitRecords
