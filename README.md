...
| OTHER | 0 | 1 | 0 | 0 | 32 |
| **TOTAL** | **427** | **64** | **50** | **353** | **579** |

477 records have a terminal curation status: 427 are `REVIEWED` and 50 are
`DEPRECATED`; two morphology records, 19 newer metabolism records,
...
│   └── traits/<category>/<slug>.yaml    # 579 curated TraitRecords
