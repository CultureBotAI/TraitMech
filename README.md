...
forty-eight physiology records, 127 genomics records, and one other
...
other).
Across the corpus, 486 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 730 curated TraitRecords
