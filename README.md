...
forty-eight physiology records, thirty-five genomics records, and one other
...
other).
Across the corpus, 394 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 638 curated TraitRecords
