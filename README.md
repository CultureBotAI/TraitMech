...
`PROPOSED`, and twenty-five records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and eighteen other).
...
│   └── traits/<category>/<slug>.yaml    # 522 curated TraitRecords
