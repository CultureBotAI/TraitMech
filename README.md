...
forty-eight physiology records, forty-six genomics records, and one other
...
other).
Across the corpus, 405 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 648 curated TraitRecords
