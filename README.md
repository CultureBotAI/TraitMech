...
forty-eight physiology records, 113 genomics records, and one other
...
other).
Across the corpus, 472 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 716 curated TraitRecords
