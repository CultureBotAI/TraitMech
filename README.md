...
forty-eight physiology records, seventy-five genomics records, and one other
...
other).
Across the corpus, 434 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 678 curated TraitRecords
