...
forty-eight physiology records, 152 genomics records, and one other
...
other).
Across the corpus, 511 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 755 curated TraitRecords
