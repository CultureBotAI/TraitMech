...
forty-eight physiology records, eighty-three genomics records, and one other
...
other).
Across the corpus, 442 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 686 curated TraitRecords
