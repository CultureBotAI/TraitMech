...
forty-eight physiology records, twenty-one genomics records, and one other
...
other).
Across the corpus, 380 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 624 curated TraitRecords
