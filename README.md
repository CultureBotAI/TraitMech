...
forty-eight physiology records, ninety-three genomics records, and one other
...
other).
Across the corpus, 452 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 696 curated TraitRecords
