...
forty-eight physiology records, twelve genomics records, and one other record are `PROPOSED`, and
thirty-eight records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and thirty-one other).
Across the corpus, 371 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 615 curated TraitRecords
