...
`PROPOSED`, and nine records are still `SEEDED` (one environment, one metabolism,
four morphology, one physiology, and two other).
...
│   └── traits/<category>/<slug>.yaml    # 506 curated TraitRecords
