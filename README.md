...
`PROPOSED`, and eighteen records are still `SEEDED` (one environment, one
metabolism, four morphology, one physiology, and eleven other).
...
│   └── traits/<category>/<slug>.yaml    # 515 curated TraitRecords
