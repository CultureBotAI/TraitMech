...
forty-eight physiology records, 168 genomics records, and one other
...
other).
Across the corpus, 527 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 771 curated TraitRecords
