...
forty-eight physiology records, ninety-four genomics records, and one other
...
other).
Across the corpus, 453 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 697 curated TraitRecords
