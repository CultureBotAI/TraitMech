...
forty-eight physiology records, 117 genomics records, and one other
...
other).
Across the corpus, 476 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 720 curated TraitRecords
