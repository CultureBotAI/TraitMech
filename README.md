...
forty-eight physiology records, 122 genomics records, and one other
...
other).
Across the corpus, 481 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 725 curated TraitRecords
