...
forty-eight physiology records, seventy-nine genomics records, and one other
...
other).
Across the corpus, 438 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 682 curated TraitRecords
