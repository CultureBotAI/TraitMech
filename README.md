...
forty-eight physiology records, nineteen genomics records, and one other
...
other).
Across the corpus, 378 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 622 curated TraitRecords
