...
forty-eight physiology records, 107 genomics records, and one other
...
other).
Across the corpus, 466 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 710 curated TraitRecords
