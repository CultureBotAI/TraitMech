...
forty-eight physiology records, twenty-four genomics records, and one other
...
other).
Across the corpus, 383 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 627 curated TraitRecords
