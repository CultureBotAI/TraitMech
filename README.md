...
forty-eight physiology records, 120 genomics records, and one other
...
other).
Across the corpus, 479 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 723 curated TraitRecords
