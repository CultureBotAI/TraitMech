...
forty-eight physiology records, forty-five genomics records, and one other
...
other).
Across the corpus, 404 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 647 curated TraitRecords
