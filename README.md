...
forty-eight physiology records, 141 genomics records, and one other
...
other).
Across the corpus, 500 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 744 curated TraitRecords
