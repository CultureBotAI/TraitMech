...
| OTHER | 0 | 0 | 0 | 0 | 22 |
| **TOTAL** | **427** | **51** | **50** | **353** | **557** |

477 records have a terminal curation status: 427 are `REVIEWED` and 50 are
`DEPRECATED`; 15 newer metabolism records and thirty-six physiology records are
...
│   └── traits/<category>/<slug>.yaml    # 557 curated TraitRecords
