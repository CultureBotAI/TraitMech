...
forty-eight physiology records, 153 genomics records, and one other
...
other).
Across the corpus, 512 records currently carry causal graphs. The 50 deprecated
records (23
...
│   └── traits/<category>/<slug>.yaml    # 756 curated TraitRecords
