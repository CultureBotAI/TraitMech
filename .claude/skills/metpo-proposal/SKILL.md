...
the next free hundred block; as of `metpo_traitmech_v81`, `METPO:1015800` is
reserved and `metpo_traitmech_v82` reserves `METPO:1015900`, so the next
one-row Scope-A cohort starts at `METPO:1016000`.
