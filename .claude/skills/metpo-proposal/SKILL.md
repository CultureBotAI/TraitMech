...
the next free hundred block; as of `metpo_traitmech_v97`, `METPO:1017400` is
reserved and `metpo_traitmech_v98` reserves `METPO:1017500`, so the next
one-row Scope-A cohort starts at `METPO:1017600`.
