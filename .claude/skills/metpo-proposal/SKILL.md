...
the next free hundred block; as of `metpo_traitmech_v102`, `METPO:1017900` is
reserved and `metpo_traitmech_v103` reserves `METPO:1018000`, so the next
one-row Scope-A cohort starts at `METPO:1018100`.
