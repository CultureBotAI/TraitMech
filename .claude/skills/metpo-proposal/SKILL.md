...
the next free hundred block; as of `metpo_traitmech_v77`, `METPO:1015400` is
reserved and `metpo_traitmech_v78` reserves `METPO:1015500`, so the next
one-row Scope-A cohort starts at `METPO:1015600`.
