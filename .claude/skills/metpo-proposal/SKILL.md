...
the next free hundred block; as of `metpo_traitmech_v92`, `METPO:1016900` is
reserved and `metpo_traitmech_v93` reserves `METPO:1017000`, so the next
one-row Scope-A cohort starts at `METPO:1017100`.
