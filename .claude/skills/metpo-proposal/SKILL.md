...
the next free hundred block; as of `metpo_traitmech_v100`, `METPO:1017700` is
reserved and `metpo_traitmech_v101` reserves `METPO:1017800`, so the next
one-row Scope-A cohort starts at `METPO:1017900`.
