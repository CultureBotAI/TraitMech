...
the next free hundred block; as of `metpo_traitmech_v87`, `METPO:1016400` is
reserved and `metpo_traitmech_v88` reserves `METPO:1016500`, so the next
one-row Scope-A cohort starts at `METPO:1016600`.
