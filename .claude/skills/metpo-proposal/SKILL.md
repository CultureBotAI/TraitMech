...
the next free hundred block; as of `metpo_traitmech_v101`, `METPO:1017800` is
reserved and `metpo_traitmech_v102` reserves `METPO:1017900`, so the next
one-row Scope-A cohort starts at `METPO:1018000`.
