...
the next free hundred block; as of `metpo_traitmech_v98`, `METPO:1017500` is
reserved and `metpo_traitmech_v99` reserves `METPO:1017600`, so the next
one-row Scope-A cohort starts at `METPO:1017700`.
