...
the next free hundred block; as of `metpo_traitmech_v99`, `METPO:1017600` is
reserved and `metpo_traitmech_v100` reserves `METPO:1017700`, so the next
one-row Scope-A cohort starts at `METPO:1017800`.
