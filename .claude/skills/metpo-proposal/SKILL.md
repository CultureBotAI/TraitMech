...
the next free hundred block; as of `metpo_traitmech_v104`, `METPO:1018100` is
reserved and `metpo_traitmech_v105` reserves `METPO:1018200`, so the next
one-row Scope-A cohort starts at `METPO:1018300`.
