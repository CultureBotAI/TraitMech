...
the next free hundred block; as of `metpo_traitmech_v88`, `METPO:1016500` is
reserved and `metpo_traitmech_v89` reserves `METPO:1016600`, so the next
one-row Scope-A cohort starts at `METPO:1016700`.
