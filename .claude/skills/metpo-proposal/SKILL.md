...
the next free hundred block; as of `metpo_traitmech_v89`, `METPO:1016600` is
reserved and `metpo_traitmech_v90` reserves `METPO:1016700`, so the next
one-row Scope-A cohort starts at `METPO:1016800`.
