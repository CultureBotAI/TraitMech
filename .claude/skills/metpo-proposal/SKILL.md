...
the next free hundred block; as of `metpo_traitmech_v82`, `METPO:1015900` is
reserved and `metpo_traitmech_v83` reserves `METPO:1016000`, so the next
one-row Scope-A cohort starts at `METPO:1016100`.
