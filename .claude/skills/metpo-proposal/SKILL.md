...
the next free hundred block; as of `metpo_traitmech_v103`, `METPO:1018000` is
reserved and `metpo_traitmech_v104` reserves `METPO:1018100`, so the next
one-row Scope-A cohort starts at `METPO:1018200`.
