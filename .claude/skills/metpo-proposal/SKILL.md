...
the next free hundred block; as of `metpo_traitmech_v85`, `METPO:1016200` is
reserved and `metpo_traitmech_v86` reserves `METPO:1016300`, so the next
one-row Scope-A cohort starts at `METPO:1016400`.
