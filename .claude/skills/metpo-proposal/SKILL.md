...
the next free hundred block; as of `metpo_traitmech_v76`, `METPO:1015300` is
reserved and `metpo_traitmech_v77` reserves `METPO:1015400`, so the next
one-row Scope-A cohort starts at `METPO:1015500`.
