...
the next free hundred block; as of `metpo_traitmech_v96`, `METPO:1017300` is
reserved and `metpo_traitmech_v97` reserves `METPO:1017400`, so the next
one-row Scope-A cohort starts at `METPO:1017500`.
