...
the next free hundred block; as of `metpo_traitmech_v95`, `METPO:1017200` is
reserved and `metpo_traitmech_v96` reserves `METPO:1017300`, so the next
one-row Scope-A cohort starts at `METPO:1017400`.
