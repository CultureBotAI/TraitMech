...
the next free hundred block; as of `metpo_traitmech_v109`, `METPO:1018600` is
reserved and `metpo_traitmech_v110` reserves `METPO:1018700`, so the next
one-row Scope-A cohort starts at `METPO:1018800`.
