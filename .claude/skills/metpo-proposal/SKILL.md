...
the next free hundred block; as of `metpo_traitmech_v80`, `METPO:1015700` is
reserved and `metpo_traitmech_v81` reserves `METPO:1015800`, so the next
one-row Scope-A cohort starts at `METPO:1015900`.
