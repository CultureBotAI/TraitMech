...
the next free hundred block; as of `metpo_traitmech_v86`, `METPO:1016300` is
reserved and `metpo_traitmech_v87` reserves `METPO:1016400`, so the next
one-row Scope-A cohort starts at `METPO:1016500`.
