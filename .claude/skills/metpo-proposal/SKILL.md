...
the next free hundred block; as of `metpo_traitmech_v106`, `METPO:1018300` is
reserved and `metpo_traitmech_v107` reserves `METPO:1018400`, so the next
one-row Scope-A cohort starts at `METPO:1018500`.
