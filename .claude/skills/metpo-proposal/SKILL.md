...
the next free hundred block; as of `metpo_traitmech_v79`, `METPO:1015600` is
reserved and `metpo_traitmech_v80` reserves `METPO:1015700`, so the next
one-row Scope-A cohort starts at `METPO:1015800`.
