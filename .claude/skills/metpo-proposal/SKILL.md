...
the next free hundred block; as of `metpo_traitmech_v84`, `METPO:1016100` is
reserved and `metpo_traitmech_v85` reserves `METPO:1016200`, so the next
one-row Scope-A cohort starts at `METPO:1016300`.
