...
the next free hundred block; as of `metpo_traitmech_v110`, `METPO:1018700` is
reserved, `metpo_traitmech_v111` reserves `METPO:1018800`, and
`metpo_traitmech_v112` reserves `METPO:1018900`, so the next one-row Scope-A
cohort starts at `METPO:1019000`.
