...
the next free hundred block; as of `metpo_traitmech_v93`, `METPO:1017000` is
reserved and `metpo_traitmech_v94` reserves `METPO:1017100`, so the next
one-row Scope-A cohort starts at `METPO:1017200`.
