...
the next free hundred block; as of `metpo_traitmech_v83`, `METPO:1016000` is
reserved and `metpo_traitmech_v84` reserves `METPO:1016100`, so the next
one-row Scope-A cohort starts at `METPO:1016200`.
