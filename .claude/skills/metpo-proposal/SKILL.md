...
the next free hundred block; as of `metpo_traitmech_v78`, `METPO:1015500` is
reserved and `metpo_traitmech_v79` reserves `METPO:1015600`, so the next
one-row Scope-A cohort starts at `METPO:1015700`.
