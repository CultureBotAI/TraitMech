...
the next free hundred block; as of `metpo_traitmech_v94`, `METPO:1017100` is
reserved and `metpo_traitmech_v95` reserves `METPO:1017200`, so the next
one-row Scope-A cohort starts at `METPO:1017300`.
