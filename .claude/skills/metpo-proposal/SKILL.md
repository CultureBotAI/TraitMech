...
the next free hundred block; as of `metpo_traitmech_v90`, `METPO:1016700` is
reserved and `metpo_traitmech_v91` reserves `METPO:1016800`, so the next
one-row Scope-A cohort starts at `METPO:1016900`.
