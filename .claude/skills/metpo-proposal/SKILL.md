...
the next free hundred block; as of `metpo_traitmech_v105`, `METPO:1018200` is
reserved and `metpo_traitmech_v106` reserves `METPO:1018300`, so the next
one-row Scope-A cohort starts at `METPO:1018400`.
