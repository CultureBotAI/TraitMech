...
the next free hundred block; as of `metpo_traitmech_v91`, `METPO:1016800` is
reserved and `metpo_traitmech_v92` reserves `METPO:1016900`, so the next
one-row Scope-A cohort starts at `METPO:1017000`.
