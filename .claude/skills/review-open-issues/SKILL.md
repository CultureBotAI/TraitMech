...
- **Maintaining a tracker issue** (the "[P0-P2 tracker]" pattern used
  ...
  first (`gh issue list --search "tracker" --state open`). TraitMech has no
  such tracker as of this writing. If the user wants one, create it with the
  Step 5 ranking as its body, and link every tracked issue number.
