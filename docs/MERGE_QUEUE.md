...
The queue runs corpus QC, the Python matrix, strict validation, taxonomy, labels, history, and vendored integrity. History presence is checked across the combined candidate, including earlier queued changes.
